...
_authoredQuizzes = <String, List<QuizQuestion>>{
  ...
  'Genesis#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel signe Dieu a-t-il donné comme promesse de ne plus '
      ...
      correctIndex: 0,
      explanation: 'L’arc-en-ciel est le signe de l’alliance (Genèse 9).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['arc-en-ciel'],
    ),
    QuizQuestion(
      text:
          'Comment s’appelait la tour que les hommes ont voulu '
          'construire ?',
      options: <String>[
        'La tour de Babel',
        'La tour de Sion',
      ...
      correctIndex: 0,
      explanation: 'À Babel, Dieu confond leur langage (Genèse 11).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Dieu appelle Abram et lui fait des promesses (Genèse 12).',
    ),
  ],
  'Exodus#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi les Égyptiens ont-ils réduit les Israélites en '
          'esclavage ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Dieu parle à Moïse depuis un buisson ardent (Exode 3).',
    ),
  ],
  'Exodus#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle fête Dieu institue-t-il avant de faire sortir '
          'Israël d’Égypte ?',
      options: <String>[
        'La Pâque',
        'La Pentecôte',
    ...
    QuizQuestion(
      text:
          'Quelle nourriture Dieu a-t-il fait tomber du ciel dans le '
          'désert ?',
  ...
  'Exodus#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui a conseillé à Moïse de déléguer la résolution des '
          'litiges ?',
  ...
  'Exodus#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que fallait-il construire selon les instructions divines '
          'données à Moïse ?',
      options: <String>[
        'Le tabernacle',
        'Un palais',
    ...
    QuizQuestion(
      text:
          'Qu’a fabriqué le peuple pendant l’absence de Moïse sur la '
          'montagne ?',
      options: <String>[
        'Un veau d’or',
      ...
      correctIndex: 0,
      explanation: 'Le peuple façonne un veau d’or et l’adore (Exode 32).',
    ),
  ],
  'Exodus#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’est-ce qui recouvrait le tabernacle une fois achevé, '
          'signe de la présence de Dieu ?',
      options: <String>[
        'Une nuée',
        'Un feu visible en plein jour',
        'Un arc-en-ciel',
        'Une étoile',
      ],
      correctIndex: 0,
  ...
  'Matthew#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui a annoncé la venue de Jésus en prêchant dans le '
          'désert ?',
      options: <String>['Jean le Baptiste', 'Élie', 'Ésaïe', 'Zacharie'],
      correctIndex: 0,
      explanation: 'Jean le Baptiste prépare le chemin de Jésus (Matthieu 3).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Jésus', 'Pierre', 'prophète'],
    ),
    QuizQuestion(
      text:
          'Combien de temps Jésus a-t-il jeûné avant d’être tenté par '
          'le Diable ?',
      options: <String>['40 jours', '7 jours', '3 jours', '100 jours'],
      correctIndex: 0,
      explanation: 'Jésus jeûne 40 jours et 40 nuits (Matthieu 4).',
      type: QuizAnswerType.freeText,
  ...
  'Matthew#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Combien de pains et de poissons Jésus a-t-il utilisés pour '
          'nourrir environ 5 000 hommes ?',
      options: <String>[
        '5 pains et 2 poissons',
        '2 pains et 5 poissons',
        '7 pains',
        '12 pains',
      ],
      correctIndex: 0,
      explanation: 'Jésus multiplie 5 pains et 2 poissons (Matthieu 14).',
      type: QuizAnswerType.wordBank,
  ...
  'Matthew#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Pierre a-t-il répondu quand Jésus a demandé « Qui '
  ...
  'Matthew#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’a institué Jésus lors de son dernier repas avec ses '
          'apôtres ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que s’est-il passé le troisième jour après la mort de '
          'Jésus ?',
      options: <String>[
        'Il est ressuscité',
  ...
  'John#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Selon Jean 1, qui était « la Parole » (le Logos) auprès de '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Jésus change l’eau en vin lors d’un mariage (Jean 2).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['pain', 'Cana', 'noces'],
    ),
    QuizQuestion(
      text:
          'Que doit faire, selon Jésus, une personne pour « voir le '
          'royaume de Dieu » ?',
      options: <String>[
        'Naître de nouveau',
        'Jeûner 40 jours',
      ...
      correctIndex: 0,
      explanation: 'Jésus l’explique à Nicodème (Jean 3).',
      type: QuizAnswerType.wordBank,
  ...
  'John#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Qui Jésus a-t-il ramené à la vie après quatre jours dans '
          'le tombeau ?',
      options: <String>[
        'Lazare',
        'Jaïrus',
    ...
    QuizQuestion(
      text:
          'Qu’a fait Jésus pour ses apôtres avant le dernier repas, '
  ...
  'John#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi Jésus compare-t-il sa relation avec ses disciples '
          'en Jean 15 ?',
      options: <String>[
        'Un cep et ses sarments',
    ...
    QuizQuestion(
      text:
          'Qui a coupé l’oreille d’un homme lors de l’arrestation de '
          'Jésus ?',
    ...
    QuizQuestion(
      text:
          'Qui a d’abord douté de la résurrection avant de toucher '
  ...
  'Leviticus#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Combien de sortes d’offrandes principales sont décrites '
    ...
    QuizQuestion(
      text:
          'Qui devait apporter les offrandes à l’entrée de la tente '
          'de réunion ?',
      options: <String>[
  ...
  'Leviticus#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Une fois par an, quel jour solennel les péchés de la '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Lévitique 19:18 est cité plus tard par Jésus lui-même.',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Jéhovah', 'cœur', 'sainteté'],
    ),
    QuizQuestion(
      text:
          'Que devait-on éviter selon Lévitique 17 concernant la '
          'nourriture ?',
      options: <String>[
        'Consommer du sang',
        'Manger la nuit',
      ...
      correctIndex: 0,
      explanation: 'La consommation de sang est interdite (Lévitique 17).',
      type: QuizAnswerType.wordBank,
  ...
  'Numbers#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi Israël a-t-il fait un recensement au désert du '
          'Sinaï ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Qui était chargé du transport et du service du '
          'tabernacle ?',
      options: <String>[
        'Les Lévites',
        'Les prêtres seuls',
    ...
    QuizQuestion(
      text:
          'Que devait faire une personne ayant fait le vœu de '
          'naziréat ?',
      options: <String>[
  ...
  'Numbers#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Combien d’espions ont donné un rapport encourageant sur '
          'Canaan ?',
  ...
  'Numbers#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quel signe a confirmé le choix d’Aaron comme grand '
          'prêtre ?',
      options: <String>[
        'Son bâton a fleuri',
        'Une voix céleste',
    ...
    QuizQuestion(
      text:
          'Pourquoi Moïse n’a-t-il pas pu entrer dans la Terre '
          'promise ?',
      options: <String>[
  ...
  'Numbers#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Qui a agi avec zèle pour arrêter le fléau lors de '
          'l’apostasie de Baal Péor ?',
      options: <String>['Phinéas', 'Josué', 'Éléazar seul', 'Caleb'],
      correctIndex: 0,
      explanation: 'Phinéas intervient et le fléau s’arrête (Nombres 25).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
  ...
  'Numbers#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quel peuple Israël a-t-il mené une guerre de '
          'jugement ?',
  ...
  'Deuteronomy#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel grand commandement Moïse répète-t-il en Deutéronome '
          '6, appelé le Shema ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Pourquoi Israël devait-il se méfier des nations de '
          'Canaan ?',
      options: <String>[
  ...
  'Deuteronomy#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quel événement du désert Moïse rappelle-t-il pour '
    ...
    QuizQuestion(
      text:
          'Où les Israélites devaient-ils apporter leurs '
      ...
      correctIndex: 0,
      explanation: 'Un lieu unique de culte est prescrit (Deutéronome 12).',
    ),
  ],
  'Deuteronomy#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Combien de témoins étaient nécessaires pour établir une '
          'accusation ?',
      options: <String>[
        'Deux ou trois',
        'Un seul suffisait',
        'Dix',
        'Aucun n’était requis',
      ],
      correctIndex: 0,
      explanation: 'La loi exige plusieurs témoins (Deutéronome 19).',
      type: QuizAnswerType.freeText,
  ...
  'Deuteronomy#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle offrande annuelle rappelait la libération '
          'd’Égypte ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel principe régissait les lois sur le divorce dans ces '
          'chapitres ?',
      options: <String>[
  ...
  'Deuteronomy#4': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Bénédictions et malédictions détaillées (Deutéronome 28).',
    ),
    QuizQuestion(
      text:
          'Quel choix Moïse présente-t-il au peuple en '
          'Deutéronome 30 ?',
      options: <String>[
  ...
  'Joshua#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle instruction Jéhovah répète-t-il à Josué au début '
          'du livre ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jéhovah encourage Josué à plusieurs reprises (Josué 1).',
      type: QuizAnswerType.wordBank,
  ...
  'Joshua#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Que s’est-il passé d’extraordinaire lors de la bataille '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Caleb reste fidèle et reçoit Hébron (Josué 14).',
      type: QuizAnswerType.freeText,
    ),
  ],
  'Joshua#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Où le tabernacle a-t-il été dressé après la conquête '
          'initiale ?',
      options: <String>['À Silo', 'À Jérusalem', 'À Hébron', 'À Béthel'],
      correctIndex: 0,
      explanation: 'La tente de réunion est établie à Silo (Josué 18).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Silo'],
    ),
    QuizQuestion(
      text:
          'Pourquoi les tribus de l’est ont-elles élevé un autel '
          'près du Jourdain ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quelle déclaration célèbre Josué fait-il à Sichem avant '
          'sa mort ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Josué appelle le peuple à choisir qui servir (Josué 24).',
    ),
  ],
  'Judges#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Le test de l’eau sélectionne 300 hommes (Juges 7).',
    ),
  ],
  'Judges#1': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Sa fille sort la première à sa rencontre (Juges 11).',
    ),
    QuizQuestion(
      text:
          'Comment reconnaissait-on les Éphraïmites au passage du '
          'Jourdain ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Le mot de passe démasque les fuyards (Juges 12).',
    ),
  ],
  'Judges#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Avec quelle arme improvisée Samson a-t-il vaincu mille '
          'Philistins ?',
      options: <String>[
        'Une mâchoire d’âne',
        'Une épée',
  ...
  'Ruth#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La famine pousse Élimélek à émigrer (Ruth 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Ruth exprime un attachement loyal célèbre (Ruth 1:16).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Élimélek, puis ses deux fils, meurent à Moab (Ruth 1).',
      type: QuizAnswerType.wordBank,
  ...
  'Ruth#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Ruth glane pour nourrir Naomi et elle-même (Ruth 2).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Boaz protège Ruth et la traite avec faveur (Ruth 2).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Naomi guide Ruth vers un possible rachat (Ruth 3).',
    ),
  ],
  'Ruth#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Boaz a-t-il réglé la question du droit de rachat '
          'devant les anciens ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Pourquoi le livre de Ruth se termine-t-il avec une '
          'généalogie ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'La généalogie relie Ruth à David (Ruth 4:17-22).',
    ),
  ],
  '1 Samuel#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Anne voue Samuel au service du tabernacle (1 Samuel 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Samuel croit d’abord qu’Éli l’appelle (1 Samuel 3).',
    ),
    QuizQuestion(
  ...
  '1 Samuel#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui Samuel a-t-il oint en secret comme premier roi '
          'd’Israël ?',
    ...
    QuizQuestion(
      text:
          'Pourquoi Saül a-t-il été définitivement rejeté comme '
          'roi par Jéhovah ?',
      options: <String>[
  ...
  '1 Samuel#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quel sentiment a poussé Saül à vouloir tuer David après '
          'sa victoire ?',
      options: <String>[
        'La jalousie',
        'La peur des Philistins',
        'La colère de Samuel',
        'Un conseil de Jonathan',
      ],
      correctIndex: 0,
      explanation:
    ...
    QuizQuestion(
      text:
          'Qui a aidé David à échapper à Saül en le prévenant du '
          'danger ?',
      options: <String>[
        'Jonathan',
        'Abner',
  ...
  '1 Samuel#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que fait David quand il a l’occasion de tuer Saül dans '
          'une grotte ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Qui a évité un conflit entre David et Nabal par sa '
          'sagesse ?',
      options: <String>['Abigaïl', 'Mical', 'Une servante', 'Le grand prêtre'],
      correctIndex: 0,
      explanation: 'Abigaïl apaise David avec des provisions (1 Samuel 25).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      text:
      ...
      correctIndex: 0,
      explanation: 'Saül et ses fils meurent au Guilboa (1 Samuel 31).',
    ),
  ],
  '2 Samuel#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment David a-t-il réagi à la mort de Saül et '
          'Jonathan ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'David compose « le Chant de l’arc » (2 Samuel 1).',
    ),
    QuizQuestion(
      text:
          'Quelle ville David a-t-il conquise pour en faire sa '
          'capitale ?',
      options: <String>['Jérusalem', 'Hébron', 'Silo', 'Guibea'],
      correctIndex: 0,
      explanation: 'David prend la forteresse de Sion (2 Samuel 5).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      text:
          'Quelle promesse Jéhovah fait-il à David par '
  ...
  '2 Samuel#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Avec qui David a-t-il commis l’adultère, entraînant le '
          'meurtre d’Urie ?',
    ...
    QuizQuestion(
      text:
          'Comment le prophète Nathan a-t-il confronté David sur '
          'son péché ?',
      options: <String>[
  ...
  '2 Samuel#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel conseil a fait échouer le plan rapide d’Ahitofel '
          'contre David ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Houshaï retarde l’attaque et sauve David (2 Samuel 17).',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      text:
          'Quel acte de David a provoqué une peste sur Israël vers '
          'la fin du livre ?',
      options: <String>[
  ...
  '1 Kings#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Que demande Salomon à Jéhovah au tout début de son '
          'règne ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Qui a aidé Salomon à fournir des matériaux pour '
  ...
  '1 Kings#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que se passe-t-il lorsque le temple est achevé et '
          'dédié ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'La nuée de gloire remplit la maison (1 Rois 8).',
    ),
    QuizQuestion(
      text:
          'Pourquoi le royaume de Salomon a-t-il fini par se '
    ...
    QuizQuestion(
      text:
          'Que fait Jéroboam après la division du royaume pour '
  ...
  '2 Kings#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quel miracle Élisée a-t-il accompli pour la femme '
          'shunamite ?',
      options: <String>[
  ...
  '2 Kings#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Qui Jéhu a-t-il éliminé pour purifier la royauté '
          'd’Israël ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Comment le jeune Joas a-t-il été protégé avant de '
          'devenir roi ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Joas échappe au massacre d’Athalie (2 Rois 11).',
    ),
  ],
  '2 Kings#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que devient le royaume du nord (Israël) après le siège '
          'assyrien ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Comment Ézéchias a-t-il réagi à la lettre menaçante de '
          'Sennachérib ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que s’est-il passé pour l’armée assyrienne assiégeant '
          'Jérusalem ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’intervention divine sauve Jérusalem (2 Rois 19).',
    ),
  ],
  '2 Kings#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’a découvert le grand prêtre Hilqiya sous le règne de '
          'Josias ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quelle grande fête Josias a-t-il célébrée après sa '
          'réforme ?',
      options: <String>[
        'La Pâque',
        'Les Tabernacles',
      ...
      correctIndex: 0,
      explanation: 'Une Pâque mémorable est célébrée (2 Rois 23).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Pâque'],
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Le récit se conclut sur l’exil à Babylone (2 Rois 25).',
    ),
  ],
  '1 Chronicles#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Les listes remontent à Adam (1 Chroniques 1-2).',
    ),
    QuizQuestion(
      text:
          'De quelle tribu la lignée royale de David est-elle '
          'issue ?',
    ...
    QuizQuestion(
      text:
          'Quelles tribus se sont établies à l’est du Jourdain '
  ...
  '1 Chronicles#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Comment l’Arche a-t-elle finalement été transportée '
      ...
      correctIndex: 0,
      explanation: 'David corrige l’erreur précédente (1 Chroniques 15).',
    ),
    QuizQuestion(
      text:
          'Contre qui David a-t-il remporté des victoires notables '
          'dans ces chapitres ?',
      options: <String>[
        'Les Philistins',
        'Les Égyptiens',
  ...
  '1 Chronicles#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quelle a été la dernière grande action publique de '
          'David avant sa mort ?',
      options: <String>[
  ...
  '2 Chronicles#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quelle prière Salomon prononce-t-il lors de la '
          'dédicace ?',
      options: <String>[
  ...
  '2 Chronicles#1': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Sa confiance en Dieu est récompensée (2 Chroniques 14).',
    ),
  ],
  '2 Chronicles#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Pourquoi Josaphat a-t-il été réprimandé par un '
          'prophète ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Son alliance avec Achab est critiquée (2 Chroniques 19).',
    ),
    QuizQuestion(
      text:
          'Comment Josaphat a-t-il remporté une victoire sans '
          'combattre ?',
      options: <String>[
  ...
  '2 Chronicles#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment le jeune Joas a-t-il été sauvé du massacre '
          'd’Athalie ?',
      options: <String>[
        'Caché dans le temple par sa tante',
  ...
  '2 Chronicles#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle grande fête Ézéchias a-t-il organisée après la '
          'purification du temple ?',
      options: <String>[
        'Une Pâque exceptionnelle',
        'Les Tabernacles',
        'Le Jubilé',
        'La Pentecôte',
      ],
  ...
  'Ezra#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui a autorisé les exilés à retourner reconstruire le '
          'temple ?',
      options: <String>[
        'Cyrus, roi de Perse',
        'Nabuchodonosor',
      ...
      correctIndex: 0,
      explanation: 'Cyrus publie un décret libérateur (Esdras 1).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Darius', 'Babylone', 'Artaxerxès'],
    ),
    QuizQuestion(
      text:
          'Qu’ont fait les exilés dès leur retour, avant même '
          'd’achever le temple ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’autel est restauré avant les fondations (Esdras 3).',
    ),
    QuizQuestion(
      text:
  ...
  'Ezra#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment les travaux de reconstruction ont-ils été '
          'interrompus ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’opposition politique bloque le chantier (Esdras 4).',
    ),
    QuizQuestion(
      text:
      ...
      correctIndex: 0,
      explanation: 'Leurs messages relancent la construction (Esdras 5).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Esdras', 'Néhémie', 'Malachie'],
    ),
    QuizQuestion(
      text:
          'Qui est arrivé plus tard de Babylone avec un groupe '
      ...
      correctIndex: 0,
      explanation: 'Esdras arrive sous le règne d’Artaxerxès (Esdras 7).',
      type: QuizAnswerType.freeText,
  ...
  'Ezra#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi Esdras n’a-t-il pas demandé d’escorte armée '
          'pour le voyage ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel problème a profondément attristé Esdras à son '
          'arrivée ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Esdras déchire ses vêtements de douleur (Esdras 9).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une réforme collective a lieu (Esdras 10).',
    ),
  ],
  'Nehemiah#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Néhémie a-t-il réagi en apprenant l’état des '
      ...
      correctIndex: 0,
      explanation: 'Sa douleur le pousse à agir (Néhémie 1).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      text:
          'Comment les bâtisseurs ont-ils réagi face aux moqueries '
          'et menaces ?',
      options: <String>[
  ...
  'Nehemiah#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle injustice sociale Néhémie a-t-il dénoncée parmi '
          'le peuple ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Néhémie corrige cette pratique injuste (Néhémie 5).',
    ),
    QuizQuestion(
      text:
          'En combien de temps la muraille de Jérusalem a-t-elle '
          'été achevée ?',
      options: <String>['52 jours', 'Un an', 'Dix ans', 'Une semaine'],
      correctIndex: 0,
      explanation: 'Un exploit malgré une forte opposition (Néhémie 6).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['cinquante-deux jours', '52'],
    ),
    QuizQuestion(
      text:
          'Que s’est-il passé lorsqu’Esdras a lu la Loi '
  ...
  'Nehemiah#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une alliance écrite scelle cet engagement (Néhémie 9-10).',
    ),
    QuizQuestion(
      text:
          'Comment la dédicace de la muraille a-t-elle été '
          'célébrée ?',
      options: <String>[
  ...
  'Esther#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Son refus entraîne sa disgrâce (Esther 1).',
    ),
    QuizQuestion(
      ...
      options: <String>[
        ...
        'Sa fille',
        'Sa sœur',
        'Une esclave étrangère',
      ],
      correctIndex: 0,
      explanation: 'Esther est choisie comme nouvelle reine (Esther 2).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Esther'],
    ),
    QuizQuestion(
      text:
          'Pourquoi Haman voulait-il exterminer tous les Juifs de '
          'l’empire ?',
      options: <String>[
  ...
  'Esther#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle phrase célèbre Mardochée adresse-t-il à Esther '
      ...
      correctIndex: 0,
      explanation: 'Cet appel pousse Esther à intervenir (Esther 4).',
    ),
    QuizQuestion(
      text:
          'Que s’est-il passé quand le roi ne trouvait pas le '
          'sommeil ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ce détail providentiel retourne la situation (Esther 6).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Haman est démasqué et exécuté (Esther 7).',
    ),
  ],
  'Esther#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quelle fête a été instituée pour commémorer cette '
          'délivrance ?',
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Mardochée œuvre pour le bien de son peuple (Esther 10).',
    ),
  ],
  'Job#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Satan met en doute la motivation de Job (Job 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Son intégrité reste intacte malgré l’épreuve (Job 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Job refuse ce conseil désespéré (Job 2).',
      type: QuizAnswerType.wordBank,
  ...
  'Job#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel argument principal Bildad avance-t-il dans son '
          'premier discours ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Bildad s’appuie sur la tradition (Job 8).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Job aspire à plaider sa cause équitablement (Job 9).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Tsophar suppose que Job cache une faute (Job 11).',
    ),
  ],
  'Job#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle affirmation célèbre Job prononce-t-il malgré sa '
          'souffrance ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Cette déclaration d’espoir marque Job 19.',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      text:
          'Comment Job décrit-il le traitement reçu de ses amis '
          'dans ces chapitres ?',
      options: <String>[
  ...
  'Job#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'De quoi Eliphaz accuse-t-il précisément Job dans son '
          'troisième discours ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Job cherche une audience équitable (Job 23).',
    ),
    QuizQuestion(
  ...
  'Job#4': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Job clôt sa défense par un vaste serment (Job 31).',
    ),
    QuizQuestion(
      text:
  ...
  'Job#5': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Dieu répond enfin, mais par des questions (Job 38).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['nuée', 'feu', 'vent'],
    ),
    QuizQuestion(
      text:
          'Sur quoi portent principalement les questions de '
          'Jéhovah à Job ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Jéhovah bénit Job plus qu’auparavant (Job 42).',
    ),
  ],
  ...
  'Psalms#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi le Psaume 1 compare-t-il l’homme heureux qui médite '
          'la loi de Dieu ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’image de l’arbre fertile ouvre le livre (Psaume 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '« Les cieux racontent la gloire de Dieu » (Psaume 19:1).',
    ),
    QuizQuestion(
      text:
          'Quelle question le Psaume 8 pose-t-il face à l’immensité '
          'de la création ?',
      options: <String>[
  ...
  'Psalms#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '« Jéhovah est mon berger » (Psaume 23:1).',
    ),
    QuizQuestion(
      text:
          'Quelle parole prophétique du Psaume 22 a été citée par '
  ...
  'Psalms#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle prière touchante David a-t-il composée après son '
      ...
      correctIndex: 0,
      explanation: '« Crée en moi un cœur pur, ô Dieu » (Psaume 51:10).',
    ),
    QuizQuestion(
      text:
          'À quoi le psalmiste compare-t-il son désir ardent de '
          'Dieu au Psaume 42 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image de soif spirituelle intense (Psaume 42:1).',
    ),
    QuizQuestion(
  ...
  'Psalms#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pour qui le Psaume 72 est-il une prière de bénédiction '
    ...
    QuizQuestion(
      text:
          'Quelle image décrit la marche puissante de Dieu dans le '
          'Psaume 68 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un langage poétique de puissance divine (Psaume 68).',
    ),
  ],
  'Psalms#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que demande Moïse à Dieu dans le Psaume 90 concernant '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une image de refuge sous les ailes divines (Psaume 91).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '« Que tes demeures sont aimables ! » (Psaume 84:1).',
    ),
  ],
  'Psalms#5': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quelle parole du Psaume 110 est appliquée au Christ dans '
      ...
      correctIndex: 0,
      explanation: 'Jésus lui-même cite ce verset (Psaume 110:1).',
    ),
  ],
  'Psalms#6': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel est le sujet principal du Psaume 119, le plus long '
      ...
      correctIndex: 0,
      explanation: 'Chaque section médite sur la loi divine (Psaume 119).',
    ),
    QuizQuestion(
      text:
          'D’où le psalmiste dit-il que vient son secours au '
          'Psaume 121 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que rappelle le Psaume 127 au sujet des projets '
          'humains ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: '« Si Jéhovah ne bâtit la maison... » (Psaume 127:1).',
    ),
  ],
  'Psalms#7': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un psaume de louange généreuse (Psaume 145:3).',
    ),
    QuizQuestion(
      text:
  ...
  'Proverbs#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Selon Proverbes 1, quel est le commencement de la '
          'connaissance ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ce principe fondamental ouvre le livre (Proverbes 1:7).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La sagesse crie sur les places publiques (Proverbes 8).',
    ),
  ],
  'Proverbs#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que dit Proverbes 15 sur la manière de répondre à la '
          'colère ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: '« Une réponse douce calme la fureur » (Proverbes 15:1).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '« Recommande à Jéhovah tes œuvres » (Proverbes 16:3).',
    ),
    QuizQuestion(
      text:
          'Que représente la femme sage qui bâtit sa maison en '
          'Proverbes 14 ?',
      options: <String>[
  ...
  'Proverbs#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Selon Proverbes 22, que vaut-il mieux qu’une grande '
          'richesse ?',
      options: <String>[
  ...
  'Proverbs#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Que dit Proverbes 29 sur l’absence de direction '
          'spirituelle ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un acrostiche loue la femme vaillante (Proverbes 31).',
      type: QuizAnswerType.wordBank,
  ...
  'Ecclesiastes#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Ce thème structure tout le livre (Ecclésiaste 1:2).',
    ),
    QuizQuestion(
      text:
          'Qu’a découvert Salomon après avoir cherché plaisir, '
          'travaux et sagesse ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que rappelle le célèbre passage sur « un temps pour '
          'tout » ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ce poème rythmé ouvre Ecclésiaste 3.',
    ),
  ],
  'Ecclesiastes#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que conseille Ecclésiaste 5 au sujet des vœux faits à '
          'Dieu ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un jugement de valeur sur l’intégrité (Ecclésiaste 7:1).',
    ),
    QuizQuestion(
      text:
      ...
      correctIndex: 0,
      explanation: 'Une prudence pratique est conseillée (Ecclésiaste 8).',
    ),
  ],
  'Ecclesiastes#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que rappelle Ecclésiaste 9 sur nos activités '
          'quotidiennes ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quelle est la conclusion finale du livre de '
          'l’Ecclésiaste ?',
      options: <String>[
  ...
  'Song of Solomon#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel sentiment domine l’ouverture du Cantique des '
          'cantiques ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Cette formule revient comme un refrain (Cantique 2:16).',
    ),
  ],
  'Song of Solomon#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment le bien-aimé décrit-il la beauté de la '
      ...
      correctIndex: 0,
      explanation: 'Un poème d’éloge détaillé lui est consacré (Cantique 4).',
    ),
    QuizQuestion(
      text:
          'Que se passe-t-il quand le bien-aimé vient frapper à sa '
          'porte au chapitre 5 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ce moment manqué crée un regret poignant (Cantique 5).',
    ),
    QuizQuestion(
      text:
          'À qui la Shulamite décrit-elle son bien-aimé après cet '
          'épisode ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Sa description enthousiaste suit (Cantique 5).',
      type: QuizAnswerType.wordBank,
  ...
  'Song of Solomon#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle affirmation célèbre sur l’amour se trouve au '
          'chapitre 8 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que symbolisent les « grandes eaux » incapables '
          'd’éteindre l’amour ?',
      options: <String>[
  ...
  'Isaiah#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une vision de paix universelle (Ésaïe 2:4).',
    ),
    QuizQuestion(
      text:
          'Que voit Ésaïe lors de sa vision de commission '
          'prophétique ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel signe Ésaïe annonce-t-il au roi Achaz au chapitre '
          '7 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: '« Emmanuel » signifie « Dieu avec nous » (Ésaïe 7:14).',
    ),
  ],
  'Isaiah#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle prophétie messianique célèbre se trouve en '
          'Ésaïe 9 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ce passage annonce un règne de paix (Ésaïe 9:6, 7).',
    ),
    QuizQuestion(
      text:
          'Quelle image pacifique illustre Ésaïe 11 concernant '
          'le règne futur ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une harmonie totale est promise (Ésaïe 11:6).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['lion', 'veau', 'enfant'],
    ),
    QuizQuestion(
      text:
          'Comment Ésaïe 14 décrit-il la chute orgueilleuse du '
          'roi de Babylone ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image saisissante de déchéance (Ésaïe 14:12).',
    ),
  ],
  'Isaiah#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel geste symbolique Ésaïe accomplit-il contre '
          'l’Égypte et Cush ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une portée mondiale est décrite (Ésaïe 24).',
    ),
    QuizQuestion(
  ...
  'Isaiah#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quelle pierre précieuse Jéhovah pose-t-il en Sion selon '
          'Ésaïe 28 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image messianique de fondement sûr (Ésaïe 28:16).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Sion', 'rocher', 'refuge'],
    ),
    QuizQuestion(
      text:
          'Contre qui Ésaïe met-il en garde le peuple concernant '
      ...
      correctIndex: 0,
      explanation: 'Chercher secours en Égypte est critiqué (Ésaïe 30-31).',
    ),
  ],
  'Isaiah#4': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une transformation joyeuse est promise (Ésaïe 35:1).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['désert', 'eau', 'joie'],
    ),
    QuizQuestion(
      text:
          'Comment Jéhovah a-t-il répondu à la prière '
    ...
    QuizQuestion(
      text:
          'Que rappelle Ésaïe 40 sur la nature humaine face à '
          'Dieu ?',
      options: <String>[
  ...
  'Isaiah#5': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Ésaïe 42 décrit-il la douceur du serviteur de '
          'Jéhovah ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel roi étranger est nommé à l’avance par Ésaïe comme '
          'libérateur d’Israël ?',
      options: <String>['Cyrus', 'Nabuchodonosor', 'Darius', 'Xerxès'],
      correctIndex: 0,
      explanation: 'Une prophétie remarquable nomme Cyrus (Ésaïe 44-45).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      text:
          'Que dit Ésaïe 48 sur l’attitude passée du peuple '
  ...
  'Isaiah#6': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Ésaïe 53 décrit-il la souffrance du serviteur '
          'de Jéhovah ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une offre généreuse et universelle (Ésaïe 55:1).',
    ),
    QuizQuestion(
      text:
          'Que définit Ésaïe 58 comme un « jeûne » véritable aux '
          'yeux de Dieu ?',
      options: <String>[
  ...
  'Isaiah#7': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un appel lumineux à la restauration (Ésaïe 60:1).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      text:
          'Que promet Ésaïe 65 concernant l’avenir de la '
          'création ?',
      options: <String>[
  ...
  'Jeremiah#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que dit Jéhovah à Jérémie sur son appel avant même sa '
          'naissance ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'À quoi Jéhovah compare-t-il l’infidélité d’Israël au '
          'chapitre 2 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image d’abandon relationnel (Jérémie 2).',
    ),
    QuizQuestion(
      text:
          'Quelle fausse confiance Jérémie dénonce-t-il au '
          'chapitre 7 ?',
      options: <String>[
  ...
  'Jeremiah#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle question célèbre Jérémie pose-t-il au chapitre '
          '12 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jérémie exprime une plainte sincère (Jérémie 12:1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un signe visuel de décadence morale (Jérémie 13).',
      type: QuizAnswerType.wordBank,
  ...
  'Jeremiah#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle illustration Jéhovah donne-t-il à Jérémie chez '
          'le potier ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image de souveraineté divine (Jérémie 18).',
    ),
    QuizQuestion(
      text:
          'Comment Jérémie a-t-il été traité après avoir prophétisé '
          'contre Jérusalem ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jérémie souffre pour son message fidèle (Jérémie 20).',
    ),
    QuizQuestion(
      text:
          'Quel choix Jérémie propose-t-il au peuple assiégé au '
          'chapitre 21 ?',
      options: <String>[
  ...
  'Jeremiah#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Combien d’années de captivité à Babylone Jérémie '
          'annonce-t-il ?',
      options: <String>['70 ans', '7 ans', '40 ans', '400 ans'],
      correctIndex: 0,
      explanation: 'Cette durée précise est prophétisée (Jérémie 25:11).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['soixante-dix ans', '70'],
    ),
    QuizQuestion(
      text:
          'Que conseille Jérémie aux exilés à Babylone dans sa '
          'lettre ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un conseil réaliste pour vivre en exil (Jérémie 29).',
    ),
  ],
  'Jeremiah#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que promet Jéhovah dans la célèbre prophétie de la '
          'nouvelle alliance ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel geste symbolique Jérémie accomplit-il en pleine '
    ...
    QuizQuestion(
      text:
          'Quel exemple de fidélité les Rékabites offrent-ils à '
          'Juda ?',
      options: <String>[
  ...
  'Jeremiah#5': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Cet Éthiopien intervient courageusement (Jérémie 38).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      text:
          'Qui a été nommé gouverneur après la chute de '
    ...
    QuizQuestion(
      text:
          'Que fait le reste du peuple malgré l’avertissement de '
  ...
  'Jeremiah#6': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quelles nations les derniers chapitres de '
    ...
    QuizQuestion(
      text:
          'Quel signe symbolique accompagne la prophétie contre '
    ...
    QuizQuestion(
      text:
          'Comment le livre de Jérémie se termine-t-il '
          'historiquement ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un épilogue historique clôt le livre (Jérémie 52).',
    ),
  ],
  'Lamentations#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Lamentations 1 décrit-il Jérusalem après sa '
          'chute ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que décrit Lamentations 2 concernant la colère de '
          'Jéhovah ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel ton domine l’ensemble de ces deux premiers '
          'chapitres ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Le livre est une élégie funèbre (Lamentations 1-2).',
    ),
  ],
  'Lamentations#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle affirmation d’espoir se trouve au cœur du '
      ...
      correctIndex: 0,
      explanation: '« Grande est ta fidélité » (Lamentations 3:22, 23).',
    ),
    QuizQuestion(
      text:
          'Comment l’auteur se décrit-il personnellement au '
          'chapitre 3 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quelle attitude le chapitre 3 recommande-t-il face à '
          'l’épreuve ?',
      options: <String>[
  ...
  'Lamentations#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle souffrance extrême le chapitre 4 rappelle-t-il '
          'durant le siège ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel sentiment domine la prière collective du dernier '
          'chapitre ?',
      options: <String>[
  ...
  'Ezekiel#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que voit Ézékiel dans sa vision inaugurale du '
          'chapitre 1 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une vision impressionnante ouvre le livre (Ézékiel 1).',
    ),
    QuizQuestion(
      text:
          'Que doit faire Ézékiel avec le rouleau qui lui est '
          'donné ?',
    ...
    QuizQuestion(
      text:
          'Quelle idolâtrie secrète Ézékiel voit-il pratiquée dans '
          'le temple même ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une vision révèle la corruption cachée (Ézékiel 8).',
    ),
  ],
  'Ezekiel#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui reçoit une marque protectrice avant le jugement de '
          'Jérusalem ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que se passe-t-il de significatif avec la gloire de '
      ...
      correctIndex: 0,
      explanation: 'Un signe grave de jugement imminent (Ézékiel 10-11).',
    ),
    QuizQuestion(
      text:
          'À quoi Jérusalem est-elle comparée dans la parabole '
          'du chapitre 16 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une allégorie saisissante de l’infidélité (Ézékiel 16).',
    ),
  ],
  'Ezekiel#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que déclare Ézékiel 18 sur la responsabilité '
          'individuelle ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel signe personnel douloureux Ézékiel vit-il au '
          'chapitre 24 ?',
      options: <String>[
  ...
  'Ezekiel#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quelles nations voisines les oracles de ces '
    ...
    QuizQuestion(
      text:
          'Comment Tyr est-elle décrite dans la lamentation '
    ...
    QuizQuestion(
      text:
          'À quoi l’Égypte est-elle comparée dans le jugement qui '
          'la concerne ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image de grandeur suivie de chute (Ézékiel 31).',
      type: QuizAnswerType.wordBank,
  ...
  'Ezekiel#4': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Que voit Ézékiel dans la célèbre vision de la vallée '
    ...
    QuizQuestion(
      text:
          'Que symbolisent les deux bâtons joints en un seul en '
          'Ézékiel 37 ?',
      options: <String>[
  ...
  'Ezekiel#5': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que revient faire la gloire de Jéhovah dans la vision '
          'du nouveau temple ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que produit le fleuve qui sort du temple selon '
          'Ézékiel 47 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image de restauration abondante (Ézékiel 47:9).',
    ),
    QuizQuestion(
      text:
          'Comment la ville finale est-elle nommée à la fin du '
          'livre ?',
      options: <String>[
        '« Jéhovah est là »',
        '« La cité éternelle »',
        '« Nouvelle Babylone »',
        '« La ville sainte » seulement',
      ],
      correctIndex: 0,
      explanation: 'Ce nom résume l’espérance du livre (Ézékiel 48:35).',
    ),
  ],
  'Daniel#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi Daniel et ses compagnons ont-ils refusé la '
          'nourriture du roi ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Leur intégrité est récompensée par la santé (Daniel 1).',
    ),
    QuizQuestion(
      text:
          'Que représente la statue du songe de Nebucadnetsar '
    ...
    QuizQuestion(
      text:
          'Que s’est-il passé quand Shadrak, Méshak et '
      ...
      correctIndex: 0,
      explanation: 'Un miracle démontre la protection divine (Daniel 3).',
    ),
  ],
  'Daniel#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel message mystérieux apparaît sur le mur pendant le '
      ...
      correctIndex: 0,
      explanation: 'Babylone tombe cette nuit-là même (Daniel 5).',
    ),
    QuizQuestion(
      text:
          'Pourquoi Daniel a-t-il été jeté dans la fosse aux '
          'lions ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Sa fidélité à la prière est mise à l’épreuve (Daniel 6).',
    ),
    QuizQuestion(
  ...
  'Daniel#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que fait Daniel avant de recevoir la prophétie des '
          '« 70 semaines » ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Qui apparaît à Daniel près du Tigre pour lui expliquer '
          'un conflit céleste ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une lutte spirituelle est révélée à Daniel (Daniel 10).',
    ),
    QuizQuestion(
  ...
  'Hosea#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’a demandé Jéhovah à Osée pour illustrer '
    ...
    QuizQuestion(
      text:
          'Quel manque Jéhovah reproche-t-il à son peuple au '
          'chapitre 4 ?',
      options: <String>[
  ...
  'Hosea#1': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        'L’amour fidèle (la bonté de cœur)',
        'Des offrandes abondantes',
        'Un temple plus grand',
        'Des cérémonies plus longues',
      ],
      correctIndex: 0,
      explanation:
    ...
    QuizQuestion(
      text:
          'Que récolte Israël après avoir « semé le vent » selon '
          'Osée 8 ?',
      options: <String>[
        'La tempête',
        'La paix durable',
      ...
      correctIndex: 0,
      explanation: 'Une image des conséquences de l’infidélité (Osée 8:7).',
      type: QuizAnswerType.freeText,
  ...
  'Hosea#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Jéhovah exprime-t-il son attachement paternel '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un appel final à la repentance et l’espoir (Osée 14).',
    ),
  ],
  'Joel#0': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        ...
        'Une guerre civile',
        'Une sécheresse de dix ans',
        'Une épidémie',
      ],
      correctIndex: 0,
      explanation: 'Un fléau sans précédent est décrit (Joël 1).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      options: <String>[
        'Se lamenter et jeûner',
        'Célébrer une fête',
        'Ignorer l’événement',
        'Émigrer immédiatement',
      ],
      correctIndex: 0,
      explanation: 'Un appel à la repentance collective (Joël 1).',
    ),
  ],
  'Joel#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une repentance sincère est demandée (Joël 2:13).',
    ),
    QuizQuestion(
      text:
          'Quelle promesse de Joël 2 est citée par Pierre le jour '
          'de la Pentecôte ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Citée en Actes 2 lors de la Pentecôte (Joël 2:28).',
    ),
  ],
  'Joel#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un jugement collectif y est annoncé (Joël 3:14).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Josaphat', 'nations', 'jugement'],
    ),
    QuizQuestion(
      text:
          'Que promet Joël 3 à Juda après le jugement des '
          'nations ?',
      options: <String>[
        'Bénédiction et restauration',
        'Une destruction définitive',
        'Un exil supplémentaire',
        'Rien de particulier',
      ],
      correctIndex: 0,
      explanation: 'Une conclusion pleine d’espérance (Joël 3).',
    ),
  ],
  'Amos#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quelles nations Amos prononce-t-il des '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Le rôle prophétique est souligné (Amos 3:7).',
    ),
  ],
  'Amos#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui Amos 4 critique-t-il en les comparant aux « vaches '
          'de Basan » ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une critique sociale directe (Amos 4:1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un appel célèbre à la justice réelle (Amos 5:24).',
    ),
  ],
  'Amos#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel instrument symbolique Dieu utilise-t-il dans une '
          'vision pour juger Israël ?',
      options: <String>[
        'Un fil à plomb',
        'Une balance vide',
        'Une trompette brisée',
        'Un sceptre royal',
      ],
      correctIndex: 0,
      explanation: 'L’image teste la droiture d’un mur (Amos 7).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une note d’espérance conclut le livre (Amos 9:11).',
    ),
  ],
  'Obadiah#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une affirmation de la souveraineté divine (Abdias 21).',
    ),
  ],
  'Jonah#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi Jonas a-t-il fui vers Tarsis au lieu d’aller '
          'à Ninive ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jonas tente de fuir sa mission (Jonas 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un événement extraordinaire le sauve (Jonas 1:17).',
    ),
  ],
  'Jonah#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une prière de détresse et de reconnaissance (Jonas 2).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un repentir collectif surprenant (Jonas 3).',
    ),
  ],
  'Jonah#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi Jonas était-il mécontent après la repentance '
          'de Ninive ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jonas peine à accepter la miséricorde divine (Jonas 4).',
    ),
    QuizQuestion(
      text:
          'Que veut enseigner Jéhovah à Jonas avec la plante qui '
          'se fane ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une leçon sur la compassion divine (Jonas 4).',
    ),
  ],
  'Micah#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quelles villes le jugement de Michée est-il '
      ...
      correctIndex: 0,
      explanation: 'Les deux capitales sont visées (Michée 1).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une injustice sociale est condamnée (Michée 2).',
    ),
  ],
  'Micah#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une prophétie messianique précise (Michée 5:2).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Jérusalem', 'Sion', 'Égypte'],
    ),
    QuizQuestion(
      text:
          'Quelle vision de paix Michée 4 partage-t-il, semblable '
          'à Ésaïe ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image de paix universelle (Michée 4:3).',
    ),
  ],
  'Micah#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quelle espérance Michée exprime-t-il malgré la '
          'corruption ambiante ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une confiance renouvelée conclut le livre (Michée 7).',
    ),
  ],
  'Nahum#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un équilibre entre patience et puissance (Nahum 1).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Ninive', 'colère', 'refuge'],
    ),
    QuizQuestion(
      text:
          'À qui Nahum offre-t-il du réconfort malgré le jugement '
          'annoncé ?',
      options: <String>[
        'À ceux qui se réfugient en lui',
        'Aux habitants de Ninive uniquement',
        'Aux rois étrangers',
        'À personne',
      ],
      correctIndex: 0,
      explanation: 'Une consolation pour les fidèles (Nahum 1:7).',
    ),
  ],
  'Nahum#1': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        'Le siège et la chute de Ninive',
        'La construction d’un temple',
        'Une fête de la moisson',
        'Un couronnement royal',
      ],
      correctIndex: 0,
      explanation: 'Une description vivante de bataille (Nahum 2).',
    ),
    QuizQuestion(
      text:
          'Quel ton domine cette description de la chute de '
          'Ninive ?',
      options: <String>[
        'Un jugement inévitable et complet',
        'Une simple mise en garde légère',
  ...
  'Nahum#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un jugement sévère pour sa violence (Nahum 3:1).',
      type: QuizAnswerType.wordBank,
  ...
  'Habakkuk#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une plainte sincère face à l’injustice (Habacuc 1).',
    ),
    QuizQuestion(
  ...
  'Habakkuk#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle vérité célèbre Habacuc 2 affirme-t-il sur le '
          'juste ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une promesse universelle d’espérance (Habacuc 2:14).',
    ),
  ],
  'Habakkuk#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle attitude Habacuc adopte-t-il dans sa prière '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un psaume de foi termine le livre (Habacuc 3).',
    ),
  ],
  'Zephaniah#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un jugement universel est annoncé (Sophonie 1).',
    ),
    QuizQuestion(
  ...
  'Zephaniah#1': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        'Chercher Jéhovah et l’humilité',
        'Se réjouir sans souci',
        'Ignorer les avertissements',
        'Fuir sans réfléchir',
      ],
      correctIndex: 0,
      explanation: 'Un appel urgent à la repentance (Sophonie 2:3).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      options: <String>[
        'Les nations voisines comme Moab et Ammon',
        'Seulement Israël',
        'Aucune autre nation',
        'Seulement Babylone',
      ],
  ...
  'Zephaniah#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une image touchante de joie divine (Sophonie 3:17).',
    ),
    QuizQuestion(
  ...
  'Haggai#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel reproche Aggée adresse-t-il au peuple revenu '
          'd’exil ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Le peuple priorisait ses propres maisons (Aggée 1).',
    ),
    QuizQuestion(
      text:
          'Quelle promesse encourage la reprise des travaux du '
          'temple ?',
      options: <String>[
  ...
  'Zechariah#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel type de révélations reçoit Zacharie au début du '
          'livre ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que symbolise la purification de Josué le grand '
  ...
  'Zechariah#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment le roi messianique futur est-il décrit en '
          'Zacharie 9 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que répond Zacharie 7-8 à la question sur le jeûne '
          'rituel ?',
      options: <String>[
  ...
  'Zechariah#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle prophétie de Zacharie 11 est associée à la '
          'trahison de Judas ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Comment le livre de Zacharie se conclut-il '
          'concernant l’avenir ?',
      options: <String>[
  ...
  'Malachi#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel reproche Malachie adresse-t-il aux prêtres au '
          'chapitre 1 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Comment Malachie 1 illustre-t-il l’amour de Jéhovah '
          'pour son peuple ?',
      options: <String>[
  ...
  'Malachi#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Quel messager Malachie 3 annonce-t-il avant la venue '
          'du Seigneur ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une prophétie liée à Jean le Baptiste (Malachie 3:1).',
      type: QuizAnswerType.wordBank,
  ...
  'Malachi#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une image de jugement final (Malachie 4:1).',
    ),
    QuizQuestion(
      text:
          'Qui Malachie annonce-t-il devoir revenir avant ce '
          'jour ?',
  ...
  'Mark#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Jean baptise et annonce la venue de Jésus (Marc 1).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Élie', 'Jésus', 'prophète'],
    ),
    QuizQuestion(
      text:
          'Comment Jésus a-t-il montré son autorité en guérissant '
      ...
      correctIndex: 0,
      explanation: 'Le pardon précède la guérison physique (Marc 2).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Les types de terrain illustrent les cœurs (Marc 4).',
    ),
  ],
  'Mark#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que s’est-il passé lorsque les cinq mille ont été '
          'nourris ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un miracle de multiplication (Marc 6).',
    ),
    QuizQuestion(
      text:
          'Quelle scène extraordinaire se produit sur la '
          'montagne en Marc 9 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jésus apparaît glorieux avec Moïse et Élie (Marc 9).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      options: <String>[
        'Monté sur un ânon, acclamé par la foule',
        'En secret, sans être vu',
        'Avec une armée',
        'À cheval en conquérant',
      ],
      correctIndex: 0,
      explanation: 'L’entrée triomphale accomplit une prophétie (Marc 11).',
    ),
  ],
  'Mark#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Jésus résume la loi en deux commandements (Marc 12).',
    ),
    QuizQuestion(
      text:
          'Qu’a institué Jésus lors du dernier repas avec ses '
          'disciples ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Le pain et le vin symbolisent son sacrifice (Marc 14).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Pâque', 'pain', 'vin'],
    ),
    QuizQuestion(
      text:
          'Que découvrent les femmes venues au tombeau le '
          'troisième jour ?',
      options: <String>[
  ...
  'Luke#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gabriel annonce la naissance miraculeuse (Luc 1).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Gabriel'],
    ),
    QuizQuestion(
      text:
          'Qui a rendu témoignage à Jésus enfant lors de sa '
      ...
      correctIndex: 0,
      explanation: 'Deux fidèles âgés reconnaissent le Messie (Luc 2).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un enseignement moral majeur (Luc 6).',
    ),
  ],
  'Luke#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle parabole célèbre illustre l’amour du prochain '
          'en Luc 10 ?',
      options: <String>[
        'Le bon Samaritain',
        'Le fils prodigue',
      ...
      correctIndex: 0,
      explanation: 'Un exemple de compassion envers un étranger (Luc 10).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['prêtre', 'Lévite', 'prochain'],
    ),
    QuizQuestion(
      text:
          'Quelles trois paraboles Jésus raconte-t-il en Luc 15 '
      ...
      correctIndex: 0,
      explanation: 'Trois images de la joie retrouvée (Luc 15).',
    ),
    QuizQuestion(
      text:
          'Que révèle la parabole du riche et de Lazare en '
          'Luc 16 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une parabole sur les priorités du cœur (Luc 16).',
    ),
  ],
  'Luke#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que fait Zachée pour montrer son changement de vie '
      ...
      correctIndex: 0,
      explanation: 'Sa générosité illustre sa conversion sincère (Luc 19).',
    ),
    QuizQuestion(
      text:
          'Que demande le malfaiteur repentant à Jésus sur le '
          'poteau ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jésus lui promet le paradis (Luc 23).',
    ),
    QuizQuestion(
      text:
          'Que se passe-t-il sur le chemin d’Emmaüs après la '
          'résurrection ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ils le reconnaissent en partageant le pain (Luc 24).',
    ),
  ],
  'Acts#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que promet Jésus à ses disciples juste avant son '
          'ascension ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une promesse essentielle avant Pentecôte (Actes 1).',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Étienne est lapidé après son discours (Actes 7).',
      type: QuizAnswerType.freeText,
    ),
  ],
  'Acts#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Saul a-t-il été transformé sur le chemin de '
          'Damas ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Sa rencontre avec Jésus change sa vie (Actes 9).',
    ),
    QuizQuestion(
      text:
          'Quelle vision Pierre reçoit-il avant de rencontrer '
          'Corneille ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Où les disciples ont-ils été appelés « chrétiens » '
          'pour la première fois ?',
      options: <String>['À Antioche', 'À Jérusalem', 'À Rome', 'À Éphèse'],
      correctIndex: 0,
      explanation: 'Ce nom apparaît d’abord à Antioche (Actes 11:26).',
      type: QuizAnswerType.freeText,
  ...
  'Acts#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle décision importante prend le conseil de '
    ...
    QuizQuestion(
      text:
          'Que s’est-il passé pour Paul et Silas emprisonnés à '
          'Philippes ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un miracle libère les prisonniers (Actes 16).',
    ),
    QuizQuestion(
      text:
          'Où Paul a-t-il prononcé son célèbre discours sur le '
          '« Dieu inconnu » ?',
      options: <String>[
        'À l’Aréopage, à Athènes',
        'À Rome',
        'À Jérusalem',
        'À Corinthe',
      ],
      correctIndex: 0,
      explanation: 'Paul s’adresse aux philosophes grecs (Actes 17).',
      type: QuizAnswerType.freeText,
  ...
  'Acts#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que raconte Paul dans sa défense après son arrestation '
          'au temple ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Paul témoigne de son expérience personnelle (Actes 22).',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      text:
          'Que s’est-il passé après le naufrage sur l’île de '
          'Malte ?',
      options: <String>[
  ...
  'Romans#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que déclare Paul sur la situation de tous les humains, '
    ...
    QuizQuestion(
      text:
          'Sur quoi repose la justification selon Romains 3-4, '
      ...
      correctIndex: 0,
      explanation: 'Abraham a été déclaré juste par la foi (Romains 4).',
    ),
  ],
  'Romans#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que déclare Romains 8 sur l’amour de Dieu envers les '
          'chrétiens ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une promesse universelle est citée (Romains 10:13).',
    ),
  ],
  'Romans#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que demande Romains 12 aux chrétiens concernant leur '
          'vie quotidienne ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un appel à une consécration pratique (Romains 12:1).',
    ),
    QuizQuestion(
      text:
          'Quel principe Romains 13 établit-il concernant les '
          'autorités ?',
      options: <String>[
  ...
  '1 Corinthians#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel problème Paul aborde-t-il dès le début de cette '
          'lettre ?',
      options: <String>[
  ...
  '1 Corinthians#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Paul aborde-t-il la question de la nourriture '
          'offerte aux idoles ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quelle attitude Paul adopte-t-il pour gagner les gens '
  ...
  '1 Corinthians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi Paul compare-t-il la diversité des dons '
    ...
    QuizQuestion(
      text:
          'Quelle qualité Paul décrit-il comme supérieure à tous '
          'les dons dans le célèbre chapitre 13 ?',
      options: <String>['L’amour', 'La richesse', 'La renommée', 'Le pouvoir'],
      correctIndex: 0,
      explanation: 'Sans amour, tout le reste est vain (1 Corinthiens 13).',
      type: QuizAnswerType.freeText,
  ...
  '2 Corinthians#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Paul décrit-il le réconfort qu’il a reçu dans '
          'l’épreuve ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'À quoi Paul compare-t-il les chrétiens transformés en '
          '2 Corinthiens 3-4 ?',
      options: <String>[
  ...
  '2 Corinthians#1': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        ...
        'Cherchez la richesse avant tout',
        'Évitez toute prédication',
        'Fuyez toute responsabilité',
      ],
      correctIndex: 0,
      explanation:
    ...
    QuizQuestion(
      text:
          'Quel principe Paul enseigne-t-il sur le don généreux '
          'en 2 Corinthiens 9 ?',
      options: <String>[
  ...
  '2 Corinthians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Paul répond-il à son « écharde dans la '
  ...
  'Galatians#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Paul défend la légitimité de sa mission (Galates 1).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une incohérence pratique est corrigée (Galates 2).',
    ),
  ],
  'Galatians#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Sur quoi repose la justification selon Galates 3, '
          'illustrée par Abraham ?',
      options: <String>[
        'La foi, et non les œuvres de la loi',
    ...
    QuizQuestion(
      text:
          'Quel rôle la loi a-t-elle joué selon Galates 3-4, en '
          'attendant Christ ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'La loi préparait à la venue du Messie (Galates 3:24).',
      type: QuizAnswerType.wordBank,
  ...
  'Galatians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel fruit de l’esprit Galates 5 met-il en avant, en '
    ...
    QuizQuestion(
      text:
          'Que conseille Galates 6 concernant les fardeaux des '
          'autres ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un appel à l’entraide fraternelle (Galates 6:2).',
      type: QuizAnswerType.wordBank,
  ...
  'Ephesians#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Par quoi les chrétiens sont-ils sauvés selon '
          'Éphésiens 2 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un principe fondamental du salut (Éphésiens 2:8, 9).',
    ),
    QuizQuestion(
      text:
          'Que réalise Christ entre Juifs et non-Juifs selon '
          'Éphésiens 2 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Le mur de séparation est abattu (Éphésiens 2:14).',
    ),
  ],
  'Ephesians#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel « mystère » Paul dit-il avoir reçu à révéler aux '
          'nations ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une inclusion inattendue des nations (Éphésiens 3:6).',
    ),
    QuizQuestion(
      text:
          'Que doivent « revêtir » les chrétiens selon '
          'Éphésiens 4 ?',
      options: <String>[
  ...
  'Ephesians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi Paul compare-t-il la relation entre le mari et '
    ...
    QuizQuestion(
      text:
          'Que représente « l’armure complète de Dieu » en '
          'Éphésiens 6 ?',
      options: <String>[
  ...
  'Philippians#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Paul perçoit-il sa situation d’emprisonnement '
          'dans cette lettre ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une attitude positive malgré l’épreuve (Philippiens 1).',
    ),
    QuizQuestion(
      text:
          'Quelle déclaration célèbre résume la perspective de '
      ...
      correctIndex: 0,
      explanation: 'Une confiance totale en Christ (Philippiens 1:21).',
    ),
  ],
  'Philippians#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel exemple d’humilité Paul propose-t-il en '
          'Philippiens 2 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un modèle d’humilité extrême (Philippiens 2:5-8).',
    ),
    QuizQuestion(
      text:
          'Que dit Paul avoir abandonné pour gagner Christ en '
          'Philippiens 3 ?',
      options: <String>[
  ...
  'Philippians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que promet Philippiens 4 à ceux qui prient sans '
          'anxiété ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une promesse de paix intérieure (Philippiens 4:6, 7).',
    ),
    QuizQuestion(
      text:
          'Quelle affirmation de confiance Paul fait-il sur sa '
          'force personnelle ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une confiance placée en Christ (Philippiens 4:13).',
    ),
  ],
  'Colossians#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Colossiens 1 décrit-il la position de Christ '
    ...
    QuizQuestion(
      text:
          'Quel « mystère » Paul dit-il avoir la mission de '
          'révéler ?',
      options: <String>[
  ...
  'Colossians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Paul encourage-t-il à se comporter envers les '
      ...
      correctIndex: 0,
      explanation: 'Un comportement avisé est recommandé (Colossiens 4:5).',
    ),
    QuizQuestion(
      text:
          'Quel ton caractérise la fin de la lettre aux '
          'Colossiens ?',
      options: <String>[
  ...
  '1 Thessalonians#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pourquoi Paul a-t-il envoyé Timothée aux '
          'Thessaloniciens ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Quel sentiment Paul exprime-t-il en apprenant leur '
  ...
  '1 Thessalonians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment 1 Thessaloniciens 4 décrit-il la résurrection '
          'des croyants ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'À quoi le jour de Jéhovah est-il comparé en '
          '1 Thessaloniciens 5 ?',
      options: <String>[
        'À un voleur dans la nuit',
        'À une fête prévisible',
        'À un jour ordinaire',
        'À un simple avertissement sans effet',
      ],
      correctIndex: 0,
      explanation:
  ...
  '2 Thessalonians#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Paul encourage-t-il les Thessaloniciens '
          'persécutés ?',
      options: <String>[
  ...
  '2 Thessalonians#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que doit se manifester avant le jour du Seigneur '
    ...
    QuizQuestion(
      text:
          'Quel encouragement Paul donne-t-il malgré cette '
          'annonce troublante ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un appel à la persévérance (2 Thessaloniciens 2:15).',
    ),
  ],
  '2 Thessalonians#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel principe Paul établit-il concernant le travail '
  ...
  '1 Timothy#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quoi Paul met-il en garde Timothée dès le '
          'début de la lettre ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Pour qui Paul demande-t-il que des prières soient '
  ...
  '1 Timothy#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelles qualités sont exigées des surveillants selon '
          '1 Timothée 3 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que dit 1 Timothée 4 sur l’exercice physique comparé '
          'à la piété ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un ordre de priorité est établi (1 Timothée 4:8).',
    ),
  ],
  '1 Timothy#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que recommande 1 Timothée 5 concernant les veuves '
          'dans le besoin ?',
      options: <String>[
  ...
  '2 Timothy#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que demande Paul à Timothée concernant son don reçu '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une fermeté malgré l’emprisonnement (2 Timothée 1:8).',
    ),
  ],
  '2 Timothy#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi Paul compare-t-il Timothée pour illustrer '
  ...
  '2 Timothy#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelle charge Paul donne-t-il à Timothée au chapitre '
          '4 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un appel pressant à la fidélité (2 Timothée 4:2).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['course', 'combat', 'couronne'],
    ),
    QuizQuestion(
      text:
          'Comment Paul résume-t-il sa vie à la fin de cette '
          'lettre ?',
      options: <String>[
  ...
  'Titus#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quelles qualités Tite doit-il rechercher chez les '
      ...
      correctIndex: 0,
      explanation: 'Des critères moraux stricts sont donnés (Tite 1).',
    ),
    QuizQuestion(
      text:
          'Contre qui Paul met-il en garde à cause de leur '
      ...
      correctIndex: 0,
      explanation: 'Un avertissement clair est donné (Tite 1:10, 11).',
      type: QuizAnswerType.freeText,
  ...
  'Titus#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que doit enseigner Tite aux différents groupes de la '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La grâce forme le caractère chrétien (Tite 2:12).',
    ),
  ],
  'Titus#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que recommande Titre 3 concernant les autorités '
          'civiles ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que faut-il éviter selon Tite 3 concernant les '
          'débats ?',
      options: <String>[
  ...
  'Philemon#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un appel à la réconciliation fraternelle (Philémon 1).',
    ),
    QuizQuestion(
      text:
          'Comment Paul propose-t-il de régler toute dette '
  ...
  'Hebrews#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Dieu a-t-il finalement parlé aux hommes selon '
          'Hébreux 1 ?',
      options: <String>[
        'Par son Fils',
        'Uniquement par des anges',
        'Par des rêves seulement',
        'Il n’a jamais parlé',
      ],
      correctIndex: 0,
      explanation:
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une image puissante de la parole divine (Hébreux 4:12).',
    ),
    QuizQuestion(
      text:
          'Contre quoi le chapitre 3 met-il en garde, à partir '
  ...
  'Hebrews#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quel ordre sacerdotal ancien Christ est-il comparé '
          'dans cette lettre ?',
      options: <String>[
        'Melchisédek',
        'Aaron seul',
      ...
      correctIndex: 0,
      explanation: 'Un sacerdoce supérieur et permanent (Hébreux 7).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['l’ordre de Melchisédek'],
    ),
    QuizQuestion(
      text:
          'Que rend possible la nouvelle alliance selon Hébreux '
          '8 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une alliance supérieure est instaurée (Hébreux 8:10).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une purification intérieure profonde (Hébreux 9:14).',
      type: QuizAnswerType.wordBank,
  ...
  'Hebrews#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel principe fondamental Hébreux 10-11 mettent-ils '
      ...
      correctIndex: 0,
      explanation: 'Une citation clé reprise d’Habacuc (Hébreux 10:38).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['œuvres', 'loi', 'Abraham'],
    ),
    QuizQuestion(
      text:
          'Quels exemples le célèbre chapitre 11 met-il en '
          'valeur ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Comment Hébreux 13 décrit-il Jésus Christ à travers '
          'le temps ?',
      options: <String>[
  ...
  'James#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Dieu donne la sagesse généreusement (Jacques 1:5).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['sagesse'],
    ),
    QuizQuestion(
      text:
          'Que dit Jacques 2 sur la relation entre la foi et les '
          'œuvres ?',
      options: <String>[
  ...
  'James#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi Jacques 3 compare-t-il le pouvoir de la langue '
          '?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une image forte sur l’impact des paroles (Jacques 3:5).',
    ),
    QuizQuestion(
      text:
          'Comment Jacques 3 distingue-t-il la sagesse d’en haut '
      ...
      correctIndex: 0,
      explanation: 'Un contraste clair est établi (Jacques 3:17).',
    ),
  ],
  'James#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que conseille Jacques 4 face à l’incertitude de '
          'l’avenir ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une leçon d’humilité pratique (Jacques 4:13-15).',
      type: QuizAnswerType.wordBank,
  ...
  '1 Peter#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'À quoi les chrétiens sont-ils nés de nouveau selon '
          '1 Pierre 1 ?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une image de communauté bâtie ensemble (1 Pierre 2:5).',
    ),
  ],
  '1 Peter#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel exemple 1 Pierre 3 propose-t-il face à la '
          'souffrance injuste ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un modèle de patience et d’intégrité (1 Pierre 3:18).',
    ),
    QuizQuestion(
      text:
          'Quelle attitude 1 Pierre 3 recommande-t-il face à '
      ...
      correctIndex: 0,
      explanation: 'Une réponse respectueuse est encouragée (1 Pierre 3:15).',
    ),
  ],
  '1 Peter#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une qualité essentielle à cultiver (1 Pierre 4:8).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['amour', 'troupeau', 'humilité'],
    ),
    QuizQuestion(
      text:
          'Quelle attitude 1 Pierre 5 demande-t-il aux anciens '
          'envers le troupeau ?',
      options: <String>[
  ...
  '2 Peter#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que Pierre encourage-t-il à ajouter à la foi en '
          '2 Pierre 1 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Comment 2 Pierre 1 décrit-il l’origine de la '
          'prophétie biblique ?',
      options: <String>[
  ...
  '2 Peter#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un avertissement détaillé est donné (2 Pierre 2).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['anges', 'Sodome', 'déluge'],
    ),
    QuizQuestion(
      text:
          'Quels exemples historiques 2 Pierre 2 cite-t-il comme '
          'avertissement ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Des exemples de jugement passé (2 Pierre 2:5, 6).',
    ),
  ],
  '2 Peter#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que diront les moqueurs des derniers jours selon '
          '2 Pierre 3 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un scepticisme est annoncé à l’avance (2 Pierre 3:4).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une espérance de renouveau (2 Pierre 3:13).',
    ),
  ],
  '1 John#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que devons-nous faire selon 1 Jean 1 si nous avons '
          'péché ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une promesse de pardon sincère (1 Jean 1:9).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['lumière', 'ténèbres', 'sang'],
    ),
    QuizQuestion(
      text:
          'Comment 1 Jean 2 nous met-il en garde contre '
          '« l’amour du monde » ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un choix clair est demandé (1 Jean 2:15).',
    ),
  ],
  '1 John#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment 1 Jean 3 définit-il les enfants de Dieu par '
      ...
      correctIndex: 0,
      explanation: 'Le comportement révèle l’appartenance (1 Jean 3:10).',
    ),
    QuizQuestion(
      ...
      options: <String>[
        ...
        'Juger sévèrement les autres',
      ],
      correctIndex: 0,
      explanation: 'Un test essentiel de la foi authentique (1 Jean 3:11).',
      type: QuizAnswerType.wordBank,
  ...
  '1 John#2': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        'Dieu est amour',
        'Dieu est distant',
        'Dieu est indifférent',
        'Dieu est sévère uniquement',
      ],
      correctIndex: 0,
      explanation: 'Une déclaration centrale de la lettre (1 Jean 4:8).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une victoire fondée sur la foi (1 Jean 5:4).',
    ),
  ],
  '2 John#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Contre quoi 2 Jean met-il en garde concernant les '
      ...
      correctIndex: 0,
      explanation: 'Une vigilance doctrinale est demandée (2 Jean 1:7, 10).',
    ),
    QuizQuestion(
      text:
          'Quel commandement Jean rappelle-t-il comme fondamental '
          'dans cette courte lettre ?',
      options: <String>[
        'S’aimer les uns les autres',
        'Éviter toute assemblée',
        'Chercher la richesse',
        'Ignorer les nouveaux venus',
      ],
      correctIndex: 0,
      explanation: 'Un rappel constant de l’amour fraternel (2 Jean 1:5).',
      type: QuizAnswerType.wordBank,
  ...
  '3 John#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Pour quelle qualité Gaïus est-il félicité dans cette '
          'lettre ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Sa générosité est mise en exemple (3 Jean 1:5).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Gaïus', 'Diotréphès', 'vérité'],
    ),
    QuizQuestion(
      text:
          'Quel comportement Diotréphès manifeste-t-il dans '
          'cette lettre ?',
      options: <String>[
  ...
  'Jude#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que demande Jude à ses lecteurs face aux infiltrés '
          'impies ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Un appel ferme à la fidélité (Jude 1:3).',
    ),
    QuizQuestion(
      text:
          'Quels exemples Jude cite-t-il comme avertissements '
          'historiques ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Des exemples de jugement passé (Jude 1:6, 7).',
      type: QuizAnswerType.wordBank,
  ...
  'Revelation#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'À combien de congrégations les lettres des chapitres '
    ...
    QuizQuestion(
      text:
          'Qui seul est trouvé digne d’ouvrir le rouleau scellé '
          'en Révélation 5 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Christ seul mérite cet honneur (Révélation 5:5-9).',
      type: QuizAnswerType.wordBank,
  ...
  'Revelation#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Une guerre céleste est décrite (Révélation 12:7).',
    ),
    QuizQuestion(
      text:
          'Que représentent les 144 000 mentionnés avec '
      ...
      correctIndex: 0,
      explanation: 'Un groupe distinct associé à l’Agneau (Révélation 14:1).',
    ),
    QuizQuestion(
      text:
          'Que contiennent les sept dernières plaies annoncées '
          'en Révélation 15 ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une étape finale du jugement divin (Révélation 15:1).',
      type: QuizAnswerType.wordBank,
  ...
  'Revelation#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Que devient « Babylone la Grande » selon Révélation '
          '17-18 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que se passe-t-il pour Satan au début de Révélation '
          '20 ?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Que promet Révélation 21-22 concernant la douleur et '
          'la mort ?',
      options: <String>[
...
_extraQuizzes = <String, List<QuizQuestion>>{
  'Genesis#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Dieu interdit ce seul arbre (Genèse 2:17).',
    ),
    QuizQuestion(
      text: 'Qui a trompé Ève pour qu’elle mange du fruit défendu ?',
      options: <String>['Le serpent', 'Caïn', 'Un ange', 'Adam'],
      correctIndex: 0,
      explanation: 'Le serpent la pousse à désobéir (Genèse 3).',
      type: QuizAnswerType.freeText,
  ...
  'Genesis#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel oiseau, envoyé par Noé, est revenu avec une feuille '
          'd’olivier ?',
      options: <String>['La colombe', 'Le corbeau', 'L’aigle', 'Le moineau'],
      correctIndex: 0,
      explanation: 'La colombe montre que les eaux baissaient (Genèse 8).',
      type: QuizAnswerType.freeText,
  ...
  'Genesis#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La circoncision marque l’alliance (Genèse 17).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Ismaël naît d’Agar la servante (Genèse 16).',
    ),
    QuizQuestion(
      text:
          'Quelles villes Dieu a-t-il détruites à cause de leur '
          'méchanceté ?',
      options: <String>[
        'Sodome et Gomorrhe',
        'Babel et Ur',
      ...
      correctIndex: 0,
      explanation: 'Le feu détruit ces villes ; Lot est sauvé (Genèse 19).',
      type: QuizAnswerType.wordBank,
  ...
  'Genesis#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’est-ce que Dieu a demandé à Abraham d’offrir sur le '
          'mont Moria ?',
      options: <String>[
        'Son fils Isaac',
        'Un bélier',
      ...
      correctIndex: 0,
      explanation: 'Dieu arrête Abraham et fournit un bélier (Genèse 22).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Ismaël', 'bélier', 'agneau'],
    ),
    QuizQuestion(
      text:
          'Contre quoi Ésaü a-t-il vendu son droit d’aînesse à '
          'Jacob ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Ésaü méprise son droit d’aînesse (Genèse 25).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Dieu confirme ses promesses à Jacob (Genèse 28).',
    ),
  ],
  'Genesis#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel nouveau nom Jacob a-t-il reçu après avoir lutté '
          'avec l’ange ?',
      options: <String>['Israël', 'Édom', 'Abraham', 'Éphraïm'],
      correctIndex: 0,
      explanation: 'Le nom Israël signifie « il lutte avec Dieu » (Genèse 32).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['le nom Israël'],
    ),
    QuizQuestion(
      text:
          'Combien de fils Jacob a-t-il eus, ancêtres des tribus '
          'd’Israël ?',
      options: <String>['Douze', 'Dix', 'Sept', 'Quatorze'],
      correctIndex: 0,
      explanation: 'Ses douze fils fondent les tribus d’Israël (Genèse 35).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['12'],
    ),
    QuizQuestion(
      text:
          'Avec qui Jacob s’est-il réconcilié après des années de '
          'séparation ?',
      options: <String>['Son frère Ésaü', 'Laban', 'Pharaon', 'Isaac'],
      correctIndex: 0,
      explanation: 'Les deux frères se retrouvent en paix (Genèse 33).',
    ),
  ],
  'Genesis#5': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Joseph est vendu et emmené en Égypte (Genèse 37).',
    ),
    QuizQuestion(
      text:
          'Quel vêtement particulier Jacob avait-il offert à '
          'Joseph ?',
      options: <String>[
        'Une belle tunique',
        'Une couronne',
        'Une armure',
        'Un manteau de prêtre',
      ],
      correctIndex: 0,
      explanation: 'Ce cadeau attise la jalousie de ses frères (Genèse 37).',
      type: QuizAnswerType.wordBank,
  ...
  'Genesis#6': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment Joseph a-t-il traité ses frères une fois qu’il '
      ...
      correctIndex: 0,
      explanation: 'Joseph pardonne et les nourrit (Genèse 45).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      text:
          'Comment Joseph voyait-il le mal que ses frères lui '
          'avaient fait ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Une déclaration célèbre de foi (Genèse 50:20).',
    ),
  ],
  'Exodus#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui était le frère de Moïse, désigné comme son '
          'porte-parole ?',
      options: <String>['Aaron', 'Josué', 'Jéthro', 'Caleb'],
      correctIndex: 0,
      explanation: 'Aaron parle au peuple pour Moïse (Exode 4).',
      type: QuizAnswerType.freeText,
  ...
  'Exodus#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Cette plaie décide Pharaon à libérer Israël (Exode 12).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['grenouilles', 'ténèbres', 'sauterelles'],
    ),
    QuizQuestion(
      text:
          'Que devaient mettre les Israélites sur leurs portes lors '
          'de la Pâque ?',
      options: <String>[
        'Du sang d’agneau',
        'De l’huile',
      ...
      correctIndex: 0,
      explanation: 'Le sang protège leurs premiers-nés (Exode 12).',
    ),
  ],
  'Exodus#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Comment de l’eau a-t-elle jailli pour le peuple assoiffé '
          'à Horeb ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Sur ordre de Dieu, Moïse frappe le rocher (Exode 17).',
    ),
    QuizQuestion(
      text:
          'Combien de commandements composent le Décalogue donné au '
          'Sinaï ?',
      options: <String>['Dix', 'Sept', 'Douze', 'Cinq'],
      correctIndex: 0,
      explanation: 'Les Dix Commandements sont donnés au Sinaï (Exode 20).',
      type: QuizAnswerType.freeText,
  ...
  'Exodus#3': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Les tables des commandements y sont placées (Exode 25).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Aaron cède à la demande du peuple (Exode 32).',
    ),
  ],
  'Exodus#4': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’est-ce qui caractérisait le visage de Moïse après '
          'qu’il ait parlé à Dieu ?',
      options: <String>[
        'Il rayonnait',
        'Il était voilé de tristesse',
        'Il avait vieilli',
        'Rien de particulier',
      ],
      correctIndex: 0,
      explanation: 'Moïse devait voiler son visage rayonnant (Exode 34).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La nuée signale la présence divine (Exode 40).',
    ),
  ],
  'Matthew#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quel modèle de prière Jésus a-t-il donné dans le Sermon '
          'sur la montagne ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jésus enseigne à prier simplement (Matthieu 6).',
    ),
    QuizQuestion(
      text:
          'À quoi ressemble celui qui met en pratique les paroles '
      ...
      correctIndex: 0,
      explanation: 'La maison sur le roc résiste aux tempêtes (Matthieu 7:24).',
    ),
  ],
  'Matthew#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qu’a fait Jésus lors d’une tempête sur la mer de '
          'Galilée ?',
      options: <String>[
        'Il l’a calmée d’un mot',
        'Il a ramé plus vite',
        'Il a attendu la fin',
        'Il a fui vers la rive',
      ],
      correctIndex: 0,
      explanation: 'Le vent et la mer lui obéissent (Matthieu 8).',
    ),
    QuizQuestion(
      text:
          'Combien d’apôtres Jésus a-t-il choisis et envoyés '
          'prêcher ?',
      options: <String>['Douze', 'Sept', 'Soixante-dix', 'Trois'],
      correctIndex: 0,
      explanation: 'Les douze apôtres sont nommés (Matthieu 10).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['12'],
    ),
  ],
  'Matthew#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Combien de fois faut-il pardonner à son frère, selon '
          'Matthieu 18 ?',
      options: <String>[
        'Jusqu’à 77 fois',
      ...
      correctIndex: 0,
      explanation: 'Jésus enseigne un pardon sans limite (Matthieu 18:22).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Jésus purifie le temple (Matthieu 21).',
    ),
  ],
  'Matthew#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quels signes Jésus a-t-il annoncés pour la conclusion du '
      ...
      correctIndex: 0,
      explanation: 'Un signe composé est décrit (Matthieu 24).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['pestes', 'signes', 'fin'],
    ),
    QuizQuestion(
      text:
          'Quelle mission Jésus a-t-il confiée à ses disciples '
      ...
      correctIndex: 0,
      explanation: 'L’ordre missionnaire clôt l’évangile (Matthieu 28:19).',
    ),
  ],
  'Mark#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui Jésus a-t-il appelés en premier au bord de la mer de '
          'Galilée ?',
      options: <String>[
        'Des pêcheurs',
        'Des prêtres',
      ...
      correctIndex: 0,
      explanation: 'Simon, André et d’autres le suivent (Marc 1).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['pêcheurs'],
    ),
    QuizQuestion(
      text:
          'Qu’a fait Jésus pour l’homme possédé de la région de '
          'Gérasa ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’homme est libéré et retrouve la raison (Marc 5).',
    ),
  ],
  'Mark#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Avec combien de pains Jésus a-t-il nourri environ 4000 '
          'personnes ?',
      options: <String>['Sept', 'Cinq', 'Douze', 'Deux'],
      correctIndex: 0,
      explanation: 'Un second miracle de multiplication (Marc 8).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['7'],
    ),
    QuizQuestion(
      text:
          'Que faut-il devenir, selon Jésus, pour entrer dans le '
          'Royaume de Dieu ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Jésus accueille les enfants en exemple (Marc 10).',
    ),
  ],
  'Mark#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Elle a donné tout ce qu’elle avait (Marc 12).',
    ),
    QuizQuestion(
      text:
          'Qui a été contraint de porter le poteau de supplice de '
          'Jésus ?',
      options: <String>['Simon de Cyrène', 'Pierre', 'Jean', 'Barabbas'],
      correctIndex: 0,
      explanation: 'Simon est réquisitionné en chemin (Marc 15).',
      type: QuizAnswerType.wordBank,
  ...
  'Luke#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La naissance a lieu à Bethléhem (Luc 2).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['à Bethléhem'],
    ),
    QuizQuestion(
      text:
          'À qui les anges ont-ils annoncé en premier la naissance '
          'de Jésus ?',
      options: <String>[
        'À des bergers',
        'À des rois',
      ...
      correctIndex: 0,
      explanation: 'Des bergers reçoivent la bonne nouvelle (Luc 2).',
    ),
  ],
  'Luke#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Combien de disciples Jésus a-t-il envoyés prêcher deux '
          'par deux en Luc 10 ?',
      options: <String>['Soixante-dix', 'Douze', 'Cent', 'Trois'],
      correctIndex: 0,
      explanation: 'Jésus élargit la prédication (Luc 10).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['70'],
    ),
    QuizQuestion(
      text:
          'Que conseille Jésus au sujet de l’inquiétude pour la '
      ...
      correctIndex: 0,
      explanation: 'Jésus enseigne la confiance en Dieu (Luc 12).',
    ),
  ],
  'Luke#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Combien de lépreux Jésus a-t-il guéris, dont un seul est '
          'revenu remercier ?',
      options: <String>['Dix', 'Sept', 'Trois', 'Douze'],
      correctIndex: 0,
      explanation: 'Seul un Samaritain revient rendre grâce (Luc 17).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['10'],
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Judas livre Jésus (Luc 22).',
    ),
  ],
  'Acts#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Combien de personnes environ ont été baptisées le jour '
          'de la Pentecôte ?',
      options: <String>[
        'Environ 3000',
        'Environ 500',
      ...
      correctIndex: 0,
      explanation: 'Un grand nombre répond au message (Actes 2).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['3000', 'trois mille'],
    ),
    QuizQuestion(
      text:
          'Qui gardait les vêtements de ceux qui lapidaient '
          'Étienne ?',
      options: <String>[
        'Saul (plus tard Paul)',
        'Pierre',
      ...
      correctIndex: 0,
      explanation: 'Saul approuvait ce meurtre (Actes 7-8).',
    ),
  ],
  'Acts#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Qui l’esprit a-t-il envoyé annoncer la bonne nouvelle à '
          'l’eunuque éthiopien ?',
      options: <String>['Philippe', 'Pierre', 'Paul', 'Jean'],
      correctIndex: 0,
      explanation: 'Philippe lui explique les Écritures (Actes 8).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      ...
      options: <String>[
        'Par un ange',
        'En soudoyant un garde',
        'Par un tremblement de terre',
        'Personne ne l’a aidé',
      ],
      correctIndex: 0,
      explanation: 'Un ange le fait sortir miraculeusement (Actes 12).',
    ),
  ],
  'Acts#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Paul travaillait de ses mains (Actes 18).',
    ),
    QuizQuestion(
      text:
          'Dans quelle ville la prédication de Paul a-t-elle '
          'provoqué une émeute des orfèvres de Diane/Artémis ?',
      options: <String>['Éphèse', 'Athènes', 'Corinthe', 'Rome'],
      correctIndex: 0,
      explanation: 'Les artisans craignaient pour leur commerce (Actes 19).',
      type: QuizAnswerType.freeText,
  ...
  'Acts#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Devant quels dirigeants Paul a-t-il témoigné à '
          'Césarée ?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Paul défend sa foi devant les autorités (Actes 24-26).',
    ),
    QuizQuestion(
      text:
          'Où Paul est-il finalement arrivé pour attendre son '
          'procès devant César ?',
      options: <String>['À Rome', 'À Jérusalem', 'À Antioche', 'À Éphèse'],
      correctIndex: 0,
      explanation: 'Paul prêche même en résidence surveillée (Actes 28).',
      type: QuizAnswerType.freeText,
...
List<Checkpoint> checkpointsForBook(BibleBook book, {String? languageCode}) {
  final Map<String, List<QuizQuestion>> authored = _authoredQuizzesFor(
    languageCode,
  );
  ...
  for (int i = 0; i < count; i++) {
    ...
    result.add(
      Checkpoint(
        ...
        questions: <QuizQuestion>[...?authored[id], ...?extra[id]],
      ),
    );
    previous = boundary;
  }
