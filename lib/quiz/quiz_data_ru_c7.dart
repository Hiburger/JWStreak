...
authoredQuizzesRuC7 = <String, List<QuizQuestion>>{
  '2 Thessalonians#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text: 'За что Павел благодарит Бога в связи с фессалоникийцами?',
      options: <String>[
        'Их вера сильно растёт, а любовь увеличивается',
        'Их богатство постоянно растёт',
        'Их число с каждым годом уменьшается',
        'Они перестали собираться вместе',
      ],
      correctIndex: 0,
      explanation:
          'Павел благодарит Бога за их успехи (2 Фессалоникийцам 1:3).',
    ),
  ],
