...
const Map<String, List<QuizQuestion>> authoredQuizzesDe = <String, List<QuizQuestion>>{
  ...authoredQuizzesDeC1,
  ...authoredQuizzesDeC2,
  ...authoredQuizzesDeC3,
  ...authoredQuizzesDeC4,
...
const Map<String, List<QuizQuestion>> extraQuizzesDe = <String, List<QuizQuestion>>{
  ...extraQuizzesDeC1,
  ...extraQuizzesDeC2,
  ...extraQuizzesDeC3,
  ...extraQuizzesDeC4,
