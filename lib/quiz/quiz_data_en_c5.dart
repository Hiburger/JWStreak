...
const Map<String, List<QuizQuestion>> authoredQuizzesEnC5 = <String, List<QuizQuestion>>{
  'Matthew#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text: 'According to the Sermon on the Mount, who is declared happy?',
      options: <String>[
        'Those who are conscious of their spiritual need',
        'The rich',
        'The powerful',
        'The famous',
      ],
      correctIndex: 0,
      explanation:
          'The Beatitudes begin with the poor in spirit '
          '(Matthew 5:3).',
    ),
  ],
  'Matthew#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text: 'What did Peter do when he saw Jesus walking on the water?',
      options: <String>[
        'He tried to walk on the water too',
        'He hid',
        'He fled',
        'He did nothing',
      ],
      correctIndex: 0,
      explanation:
          'Peter walks toward Jesus but begins to sink for '
          'lack of faith (Matthew 14).',
    ),
    QuizQuestion(
      ...
      explanation:
          ...
          'head (Matthew 14).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Salome', 'the daughter of Herodias'],
    ),
  ],
  'Matthew#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Peter recognizes Jesus as the Christ (Matthew 16).',
    ),
    QuizQuestion(
      text: 'What happened at the transfiguration?',
      options: <String>[
    ...
    QuizQuestion(
      ...
      explanation:
          ...
          'prophecy (Matthew 21).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['horse', 'camel', 'chariot'],
    ),
  ],
  'Matthew#3': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation:
          'Jesus institutes the memorial meal with bread and wine '
          '(Matthew 26).',
    ),
    QuizQuestion(
      text: 'Who betrayed Jesus for thirty pieces of silver?',
      options: <String>['Judas Iscariot', 'Peter', 'Thomas', 'Barabbas'],
      correctIndex: 0,
      explanation: 'Judas betrays Jesus (Matthew 26).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Judas'],
    ),
    QuizQuestion(
      text: 'What happened on the third day after Jesus’ death?',
      options: <String>[
        'He was resurrected',
      ...
      correctIndex: 0,
      explanation: 'Jesus is resurrected on the third day (Matthew 28).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['tomb', 'angel', 'stone'],
    ),
  ],
  'John#0': <QuizQuestion>[
    QuizQuestion(
    ...
    QuizQuestion(
      text: 'What was Jesus’ first miracle, performed at Cana?',
      options: <String>[
  ...
  'John#1': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Jesus resurrects Lazarus (John 11).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      ...
      options: <String>[
        ...
        'He blessed them one by one',
        'He shared his belongings',
        'He prayed publicly for each of them',
      ],
      correctIndex: 0,
      explanation: 'Jesus washes his disciples’ feet (John 13).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['hands', 'bread', 'basin'],
    ),
  ],
  'John#2': <QuizQuestion>[
    QuizQuestion(
    ...
    QuizQuestion(
      text: 'Who cut off a man’s ear during Jesus’ arrest?',
      options: <String>['Peter', 'John', 'James', 'Andrew'],
      correctIndex: 0,
      explanation: 'Peter strikes Malchus with a sword (John 18).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Thomas doubts and then believes (John 20).',
      type: QuizAnswerType.freeText,
    ),
  ],
  'Mark#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      options: <String>[
        ...
        'By demanding a sacrifice first',
        'By sending him away without an answer',
    ...
    QuizQuestion(
      ...
      options: <String>[
        ...
        'A simple lesson in farming',
        'A judgment against farmers',
  ...
  'Mark#1': <QuizQuestion>[
    QuizQuestion(
      text: 'What happened when the five thousand were fed?',
      options: <String>[
        'Five loaves and two fish were enough, with some left over',
        'Everyone had brought their own food',
        'The crowd went away hungry',
  ...
  'Mark#2': <QuizQuestion>[
    QuizQuestion(
      text: 'What great commandment does Jesus cite in Mark 12?',
      options: <String>[
        'Love God with your whole heart and your neighbor as yourself',
        'Pay taxes scrupulously',
        'Fast every week',
    ...
    QuizQuestion(
      ...
      options: <String>[
        ...
        'The tomb is sealed and inaccessible',
        'Nothing unusual',
      ],
      correctIndex: 0,
      explanation:
  ...
  'Luke#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text: 'What famous discourse does Jesus deliver in Luke 6?',
      options: <String>[
        'The Sermon on the Plain, with blessings and woes',
        'A discourse on taxes',
  ...
  'Luke#1': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      options: <String>[
        ...
        'The sower, the net, the pearl',
        'The fig tree, the vine, the wheat',
  ...
  'Luke#2': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        ...
        'He leaves the city',
        'He ends up ignoring Jesus',
        'He refuses to share his belongings',
      ],
      correctIndex: 0,
      explanation:
  ...
  'Acts#0': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        ...
        'They will immediately rule over Rome',
    ...
    QuizQuestion(
      ...
      options: <String>[
        'The holy spirit was poured out on the disciples',
        'An earthquake destroyed the temple',
        'The apostles fled Jerusalem',
        'Nothing unusual happened',
      ],
      correctIndex: 0,
      explanation:
          'The Christian congregation begins that day '
          '(Acts 2).',
    ),
    QuizQuestion(
  ...
  'Acts#1': <QuizQuestion>[
    QuizQuestion(
      text: 'How was Saul transformed on the road to Damascus?',
      options: <String>[
        'A light and a voice from Jesus converted him',
        'He simply changed his mind on his own',
        'A king forced him to change',
    ...
    QuizQuestion(
      ...
      options: <String>[
        'A large sheet with animals, signifying openness '
            'to non-Jews',
        'A heavenly battle',
        'A temple in flames',
        'A meaningless dream',
      ...
      correctIndex: 0,
      explanation:
          'This vision prepares Peter to preach the good '
          'news to the nations (Acts 10).',
    ),
    QuizQuestion(
  ...
  'Acts#2': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        ...
        'They must follow the whole Law of Moses',
        'They are excluded from the congregation',
        'No decision is made',
      ],
      correctIndex: 0,
      explanation:
          'A key decision for the expansion of Christianity '
          '(Acts 15).',
    ),
    QuizQuestion(
      text: 'What happened to Paul and Silas imprisoned at Philippi?',
      options: <String>[
        'An earthquake opened the prison doors',
        'They escaped secretly',
        'They remained locked up for life',
        'No one intervened',
      ],
      correctIndex: 0,
      explanation:
  ...
  'Acts#3': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      options: <String>[
        'To get a fair trial as a Roman citizen',
        'To avoid any trial',
        'To be released immediately',
        'Because he wanted to leave the ministry',
      ],
      correctIndex: 0,
      explanation:
          'His status as a Roman citizen gives him this right '
          '(Acts 25).',
    ),
    QuizQuestion(
      ...
      options: <String>[
        ...
        'He was arrested by the inhabitants',
        'The ship set off again immediately',
        'Nothing in particular happened',
      ],
      correctIndex: 0,
      explanation:
          'Paul is unharmed despite the viper bite, amazing the '
          'islanders (Acts 28).',
    ),
  ],
};
...
const Map<String, List<QuizQuestion>> extraQuizzesEnC5 = <String, List<QuizQuestion>>{
  'Matthew#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      options: <String>[
        ...
        'A man who builds on the sand',
        'An aimless traveler',
        'A king without a kingdom',
      ],
      correctIndex: 0,
      explanation:
          'The house on the rock withstands the storms (Matthew 7:24).',
    ),
  ],
  'Matthew#1': <QuizQuestion>[
    QuizQuestion(
  ...
  'Matthew#3': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        ...
        'Immediate worldwide peace',
        'The sun disappearing forever',
        'No signs at all',
      ],
      correctIndex: 0,
      explanation:
  ...
  'Mark#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      options: <String>[
        ...
        'He ignored him',
        'He sent him home without doing anything',
  ...
  'Mark#2': <QuizQuestion>[
    QuizQuestion(
      text: 'What small offering did Jesus praise at the temple?',
      options: <String>[
  ...
  'Acts#3': <QuizQuestion>[
    QuizQuestion(
      text: 'Before which rulers did Paul testify at Caesarea?',
      options: <String>[
        'Felix, Festus, and King Agrippa',
        'Pilate and Herod',
        'The Sanhedrin alone',
        'Caesar himself',
      ],
