...
authoredQuizzesZhC3 = <String, List<QuizQuestion>>{
  'Esther#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '末底改抚养了谁，后来谁成了王后？',
      options: <String>['以斯帖，他的堂妹', '他的女儿', '他的姐妹', '一个外族奴隶'],
      correctIndex: 0,
      explanation: '以斯帖被选为新王后（以斯帖记2章）。',
    ),
    QuizQuestion(
  ...
  'Esther#1': <QuizQuestion>[
    QuizQuestion(
      text: '末底改对以斯帖说了什么名言，说服她采取行动？',
      options: <String>[
        '“谁知道你得了王后的位分，不是为现今的机会吗？”',
        '“趁着还有时间赶紧逃走”',
        '“这不是我们的问题”',
        '“王绝不会听你的”',
      ],
      correctIndex: 0,
      explanation: '这个恳求打动以斯帖采取行动（以斯帖记4章）。',
    ),
    QuizQuestion(
  ...
  'Esther#2': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '为纪念这次拯救，设立了什么节日？',
      options: <String>['普珥节', '逾越节', '住棚节', '禧年'],
      correctIndex: 0,
      explanation: '普珥节至今仍纪念这件事（以斯帖记9章）。',
    ),
    QuizQuestion(
      text: '末底改后来担任了什么职位？',
  ...
  'Job#2': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '约伯质疑朋友们过分简单化的理论（约伯记21章）。',
    ),
    QuizQuestion(
      text: '在这几章里，约伯怎样描述朋友们对待他的方式？',
      options: <String>[
        '他觉得自己被他们抛弃、不被他们理解',
        '他热情地感谢他们',
        '他赞同他们所有的论点',
      ...
      correctIndex: 0,
      explanation: '约伯表达了他们缺乏同情心带来的痛苦（约伯记16-17章）。',
    ),
  ],
  'Job#3': <QuizQuestion>[
    QuizQuestion(
  ...
  'Job#5': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '耶和华赐福给约伯，比从前更加丰盛（约伯记42章）。',
    ),
  ],
  ...
  'Psalms#1': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这句引言把这首诗篇和基督的苦难联系起来（诗篇22:1）。',
    ),
    QuizQuestion(
      text: '诗篇34篇怎样宣告耶和华的良善？',
      options: <String>[
        '你们要亲自尝尝，就知道耶和华是良善的',
        '他的良善一直隐而不显',
        '这只关乎祭司',
      ...
      correctIndex: 0,
      explanation: '这是邀请人亲身体验上帝良善的话（诗篇34:8）。',
    ),
  ],
  'Psalms#2': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '“上帝是我们的避难所，是我们的力量”（诗篇46:1）。',
    ),
  ],
  ...
  'Psalms#4': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这是一幅在上帝翅膀荫庇之下得庇护的意象（诗篇91篇）。',
    ),
    QuizQuestion(
      text: '诗篇84篇怎样论到上帝的居所？',
  ...
  'Psalms#5': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '诗篇103篇怎样论到上帝的宽恕？',
      options: <String>[
        '他饶恕我们一切过犯，就像父亲怜恤儿女一样',
        '他从不宽恕人',
        '宽恕取决于每天献的祭',
        '只有祭司才得蒙宽恕',
      ],
      correctIndex: 0,
      explanation: '这是一幅父亲慈怜怜悯儿女的温馨意象（诗篇103:13）。',
    ),
    QuizQuestion(
  ...
  'Psalms#6': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '诗篇127篇提醒我们关于人的计划要注意什么？',
      options: <String>[
        '若不是耶和华建造房屋，建造的人就徒然劳苦',
        '成功只取决于自己的努力',
        '一切全凭运气决定',
        '儿女并不是福分',
      ],
      correctIndex: 0,
      explanation: '“若不是耶和华建造房屋……”（诗篇127:1）。',
    ),
  ],
  ...
  'Proverbs#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '箴言16章论到我们的计划和耶和华的关系时说了什么？',
      options: <String>[
        '把你的工作交托给耶和华，你的计划就会成功',
        '人的计划只取决于自己',
        '耶和华并不理会我们每天的决定',
        '什么都不计划反而更好',
      ],
      correctIndex: 0,
      explanation: '“要把你的工作交托给耶和华”（箴言16:3）。',
    ),
    QuizQuestion(
  ...
  'Proverbs#3': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这是一幅正面相互影响的意象（箴言27:17）。',
    ),
    QuizQuestion(
  ...
  'Ecclesiastes#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '他亲身的经历说明了没有上帝，一切都是虚空的（传道书2章）。',
    ),
    QuizQuestion(
  ...
  'Ecclesiastes#2': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这是慷慨而满怀信心地投资的意象（传道书11:1）。',
    ),
    QuizQuestion(
      text: '传道书全书最后的结论是什么？',
  ...
  'Song of Solomon#0': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这句话像副歌一样反复出现（雅歌2:16）。',
    ),
  ],
  ...
  'Isaiah#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '以赛亚在他蒙召作先知的异象中看到了什么？',
      options: <String>[
        '耶和华坐在崇高的宝座上，四周围绕着撒拉弗',
        '一场天上的战役',
        '一片寂静的沙漠',
        '只有一座废墟中的城市',
      ],
      correctIndex: 0,
      explanation: '一块炭触碰他的嘴唇，洁净了他的口（以赛亚书6章）。',
    ),
    QuizQuestion(
      text: '以赛亚在第7章向亚哈斯王宣告了什么征兆？',
      options: <String>[
        '有个少女要怀孕生一个儿子，名叫以马内利',
        '立刻会有一场军事上的胜利',
        '犹大将彻底被毁灭',
      ...
      correctIndex: 0,
      explanation: '“以马内利”的意思是“上帝与我们同在”（以赛亚书7:14）。',
    ),
  ],
  'Isaiah#1': <QuizQuestion>[
    QuizQuestion(
      text: '以赛亚书9章有什么著名的弥赛亚预言？',
      options: <String>[
        '有一个孩子为我们而生，政权担在他的肩头上',
        '一位外邦的王将永远统治',
        '圣殿会立刻被重建',
        '和平永远不会来临',
      ],
      correctIndex: 0,
      explanation: '这段经文预告了一个和平的统治（以赛亚书9:6, 7）。',
    ),
    QuizQuestion(
  ...
  'Isaiah#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '根据以赛亚书28章，耶和华在锡安安放了什么宝贵的石头？',
      options: <String>[
        '一块房角石，一个经过考验的根基',
        '一块普通的小石子',
        '一块受咒诅的石头',
      ...
      correctIndex: 0,
      explanation: '这是描绘稳固根基的弥赛亚意象（以赛亚书28:16）。',
    ),
    QuizQuestion(
  ...
  'Isaiah#4': <QuizQuestion>[
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '祷告之后随即发生了一场惊人的拯救（以赛亚书37章）。',
    ),
    QuizQuestion(
  ...
  'Isaiah#5': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '以赛亚预先点名哪位外邦君王将成为以色列的解放者？',
      options: <String>['居鲁士', '尼布甲尼撒', '大流士', '薛西斯'],
      correctIndex: 0,
      explanation: '这是一个了不起的预言，点名了居鲁士（以赛亚书44-45章）。',
    ),
    QuizQuestion(
  ...
  'Isaiah#7': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '耶稣在拿撒勒会堂里诵读的是以赛亚书61章的哪句宣告？',
      options: <String>[
        '“至高主宰耶和华的灵在我身上”',
        '“我要来审判全世界”',
        '“圣殿将被摧毁”',
      ...
      correctIndex: 0,
      explanation: '耶稣把这段经文应用在自己身上（路加福音4章，引自以赛亚书61:1）。',
    ),
    QuizQuestion(
  ...
  'Jeremiah#0': <QuizQuestion>[
    QuizQuestion(
      text: '耶和华论到耶利米还没出生之前就蒙拣选这件事，对他说了什么？',
      options: <String>[
        '“我还没有在腹中造你，就已经认识你了”',
        '他直到成年才被拣选',
        '耶利米是自己毛遂自荐的',
      ...
      correctIndex: 0,
      explanation: '这项先知职分早在他出生之前就已确立（耶利米书1:5）。',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '民众错误地以为圣殿会自动保护他们（耶利米书7章）。',
    ),
  ],
  'Jeremiah#1': <QuizQuestion>[
    QuizQuestion(
      text: '耶利米在第12章提出了什么著名的问题？',
      options: <String>[
        '恶人的道路为什么如此亨通？',
        '巴比伦为什么这么衰弱？',
        '圣殿为什么空无一人？',
      ...
      correctIndex: 0,
      explanation: '耶利米发出了一句真诚的怨言（耶利米书12:1）。',
    ),
    QuizQuestion(
  ...
  'Jeremiah#2': <QuizQuestion>[
    QuizQuestion(
      text: '耶和华在陶匠家里给耶利米什么启示？',
      options: <String>[
        '就像陶泥在陶匠手中一样，以色列也在上帝手中',
        '陶匠象征一位外邦的王',
        '陶泥代表财富',
        '这里没有得出任何属灵的教训',
      ],
      correctIndex: 0,
      explanation: '这是描绘上帝至高主权的意象（耶利米书18章）。',
    ),
    QuizQuestion(
      text: '耶利米发预言谴责耶路撒冷之后，受到了怎样的对待？',
      options: <String>[
        '巴施户珥把他打了一顿，还给他上了枷锁',
        '他受到公开的表彰',
        '他被立为大祭司',
      ...
      correctIndex: 0,
      explanation: '耶利米因忠信传讲信息而受苦（耶利米书20章）。',
    ),
    QuizQuestion(
  ...
  'Jeremiah#3': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这个弥赛亚式的应许，与恶劣的牧人形成对比（耶利米书23:5）。',
    ),
    QuizQuestion(
      text: '耶利米预告在巴比伦被掳会持续多少年？',
      options: <String>['70年', '7年', '40年', '400年'],
      correctIndex: 0,
      explanation: '这个确切的年数是预言中提到的（耶利米书25:11）。',
    ),
    QuizQuestion(
  ...
  'Jeremiah#4': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: '这里预告了一个深入人心、切身相关的约（耶利米书31:33）。',
    ),
    QuizQuestion(
      text: '耶利米在危机正酣之际购买了一块田地，这个象征性的举动代表什么？',
      options: <String>[
        '他借此表明自己对未来复兴的信心',
        '他想借机为自己敛财',
        '他要逃离被围困的城市',
      ...
      correctIndex: 0,
      explanation: '尽管城被围困，这次购地行动却见证了盼望（耶利米书32章）。',
    ),
    QuizQuestion(
  ...
  'Jeremiah#5': <QuizQuestion>[
    QuizQuestion(
      text: '耶利米被扔进泥泞的坑里之后，是谁救了他？',
      options: <String>['以伯米勒', '巴录', '基大利', '以实玛利'],
      correctIndex: 0,
      explanation: '这位古实人勇敢地出手相助（耶利米书38章）。',
    ),
    QuizQuestion(
      text: '耶路撒冷陷落之后，谁被立为总督，后来却遭到暗杀？',
      options: <String>['基大利', '西底家', '以实玛利', '巴录'],
      correctIndex: 0,
      explanation: '他的遇害引发了新一轮的动荡（耶利米书40-41章）。',
    ),
    QuizQuestion(
  ...
  'Jeremiah#6': <QuizQuestion>[
    ...
    QuizQuestion(
      text: '交给西莱雅、针对巴比伦的预言，伴随着什么象征性的记号？',
      options: <String>[
        '书卷被扔进幼发拉底河里沉下去',
        '书卷被公开焚烧',
        '书卷在巴比伦王面前被诵读',
      ...
      correctIndex: 0,
      explanation: '这象征巴比伦最终的覆亡（耶利米书51章）。',
    ),
    QuizQuestion(
      text: '耶利米书从历史的角度来说是怎样结束的？',
      options: <String>[
        '以约雅斤在巴比伦获释出狱作结',
        '以全体民众立刻归回作结',
        '以圣殿的重建作结',
      ...
      correctIndex: 0,
      explanation: '一段历史性的尾声为全书画上句点（耶利米书52章）。',
    ),
  ],
};
