...
const Map<String, List<QuizQuestion>> authoredQuizzesRu = <String, List<QuizQuestion>>{
  ...authoredQuizzesRuC1,
  ...authoredQuizzesRuC2,
  ...authoredQuizzesRuC3,
  ...authoredQuizzesRuC4,
...
const Map<String, List<QuizQuestion>> extraQuizzesRu = <String, List<QuizQuestion>>{
  ...extraQuizzesRuC1,
  ...extraQuizzesRuC2,
  ...extraQuizzesRuC3,
  ...extraQuizzesRuC4,
