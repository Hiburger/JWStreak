...
const Map<String, List<QuizQuestion>> authoredQuizzesZh = <String, List<QuizQuestion>>{
  ...authoredQuizzesZhC1,
  ...authoredQuizzesZhC2,
  ...authoredQuizzesZhC3,
  ...authoredQuizzesZhC4,
...
const Map<String, List<QuizQuestion>> extraQuizzesZh = <String, List<QuizQuestion>>{
  ...extraQuizzesZhC1,
  ...extraQuizzesZhC2,
  ...extraQuizzesZhC3,
  ...extraQuizzesZhC4,
