...
authoredQuizzesItC5 = <String, List<QuizQuestion>>{
  'Matthew#0': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Per quanto tempo digiunò Gesù prima di essere tentato dal Diavolo?',
  ...
  'Matthew#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Come rispose Pietro quando Gesù chiese: «Chi dite voi che io sia?»?',
      options: <String>[
  ...
  'Matthew#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Che cosa istituì Gesù durante il suo ultimo pasto con gli apostoli?',
      options: <String>[
  ...
  'John#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Secondo Giovanni 1, chi era «la Parola» (il Logos) presso Dio al '
          'principio?',
      options: <String>[
    ...
    QuizQuestion(
      text:
          'Che cosa deve fare, secondo Gesù, una persona per «vedere il '
          'regno di Dio»?',
      options: <String>[
        'Nascere di nuovo',
        'Digiunare 40 giorni',
      ...
      correctIndex: 0,
      explanation: 'Gesù lo spiega a Nicodemo (Giovanni 3).',
      type: QuizAnswerType.freeText,
  ...
  'John#1': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Che cosa fece Gesù per i suoi apostoli prima dell’ultima cena, '
  ...
  'John#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'A che cosa paragona Gesù la sua relazione con i discepoli in '
          'Giovanni 15?',
      options: <String>[
        'Una vite e i suoi tralci',
    ...
    QuizQuestion(
      text:
          'Chi dubitò dapprima della risurrezione prima di toccare le '
          'ferite di Gesù?',
  ...
  'Mark#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Giovanni battezza e annuncia la venuta di Gesù (Marco 1).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['Gesù', 'Elia', 'Pietro'],
    ),
    QuizQuestion(
      text:
          'Come mostrò Gesù la sua autorità guarendo il paralitico calato '
          'dal tetto?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Il perdono precede la guarigione fisica (Marco 2).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'I diversi tipi di terreno illustrano i cuori (Marco 4).',
    ),
  ],
  'Mark#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un miracolo di moltiplicazione (Marco 6).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gesù appare glorioso insieme a Mosè ed Elia (Marco 9).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      options: <String>[
        'In sella a un asinello, acclamato dalla folla',
        'Di nascosto, senza farsi vedere',
        'Con un esercito',
        'A cavallo da conquistatore',
      ],
      correctIndex: 0,
      explanation: 'L’ingresso trionfale adempie una profezia (Marco 11).',
    ),
  ],
  'Mark#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gesù riassume la legge in due comandamenti (Marco 12).',
    ),
    QuizQuestion(
  ...
  'Luke#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gabriele annuncia la nascita miracolosa (Luca 1).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['Gabriele'],
    ),
    QuizQuestion(
      text:
          'Chi rese testimonianza a Gesù bambino durante la sua '
      ...
      correctIndex: 0,
      explanation: 'Due fedeli anziani riconoscono il Messia (Luca 2).',
      type: QuizAnswerType.wordBank,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un importante insegnamento morale (Luca 6).',
    ),
  ],
  'Luke#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quale celebre parabola illustra l’amore per il prossimo in '
          'Luca 10?',
      options: <String>[
        'Il buon Samaritano',
        'Il figlio prodigo',
      ...
      correctIndex: 0,
      explanation: 'Un esempio di compassione verso uno straniero (Luca 10).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['sacerdote', 'levita', 'locandiere'],
    ),
    QuizQuestion(
      text:
          'Quali tre parabole racconta Gesù in Luca 15 su ciò che è '
          'perduto?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Tre immagini della gioia ritrovata (Luca 15).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Una parabola sulle priorità del cuore (Luca 16).',
    ),
  ],
  'Luke#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Che cosa fa Zaccheo per mostrare il cambiamento della sua vita '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gesù gli promette il paradiso (Luca 23).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Lo riconoscono mentre spezza il pane (Luca 24).',
    ),
  ],
  'Acts#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Che cosa promette Gesù ai suoi discepoli poco prima della sua '
          'ascensione?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Una promessa essenziale prima della Pentecoste (Atti 1).',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Stefano viene lapidato dopo il suo discorso (Atti 7).',
      type: QuizAnswerType.freeText,
    ),
  ],
  'Acts#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Il suo incontro con Gesù cambia la sua vita (Atti 9).',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      text:
          'Dove i discepoli furono chiamati «cristiani» per la prima '
          'volta?',
  ...
  'Acts#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quale importante decisione prende il concilio di Gerusalemme '
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un miracolo libera i prigionieri (Atti 16).',
    ),
    QuizQuestion(
      text:
          'Dove pronunciò Paolo il suo celebre discorso sul «Dio '
          'sconosciuto»?',
      options: <String>[
        'All’Areopago, ad Atene',
        'A Roma',
        'A Gerusalemme',
        'A Corinto',
      ],
      correctIndex: 0,
      explanation: 'Paolo si rivolge ai filosofi greci (Atti 17).',
      type: QuizAnswerType.freeText,
  ...
  'Acts#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Che cosa racconta Paolo nella sua difesa dopo il suo arresto '
          'al tempio?',
      options: <String>[
...
const Map<String, List<QuizQuestion>>
extraQuizzesItC5 = <String, List<QuizQuestion>>{
  'Matthew#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gesù insegna a pregare in modo semplice (Matteo 6).',
    ),
    QuizQuestion(
      text:
          'A che cosa somiglia chi mette in pratica le parole di Gesù, '
          'secondo Matteo 7?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'La casa sulla roccia resiste alle tempeste (Matteo 7:24).',
    ),
  ],
  'Matthew#1': <QuizQuestion>[
    QuizQuestion(
      ...
      options: <String>[
        'La calmò con una parola',
        'Remò più veloce',
        'Attese che finisse',
        'Fuggì verso la riva',
      ],
      correctIndex: 0,
      explanation: 'Il vento e il mare gli obbediscono (Matteo 8).',
    ),
    QuizQuestion(
      text: 'Quanti apostoli scelse e mandò a predicare Gesù?',
      options: <String>['Dodici', 'Sette', 'Settanta', 'Tre'],
      correctIndex: 0,
      explanation: 'Vengono nominati i dodici apostoli (Matteo 10).',
      type: QuizAnswerType.freeText,
  ...
  'Matthew#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quante volte bisogna perdonare il proprio fratello, secondo '
          'Matteo 18?',
      options: <String>[
        'Fino a 77 volte',
        'Solo tre volte',
      ...
      correctIndex: 0,
      explanation: 'Gesù insegna un perdono senza limiti (Matteo 18:22).',
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Gesù purifica il tempio (Matteo 21).',
      type: QuizAnswerType.wordBank,
  ...
  'Matthew#3': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quali segni annunciò Gesù per la conclusione del sistema in '
          'Matteo 24?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Viene descritto un segno composito (Matteo 24).',
      type: QuizAnswerType.wordBank,
      wordBankDistractors: <String>['pestilenze', 'pace', 'ricchezze'],
    ),
    QuizQuestion(
      text:
          'Quale missione affidò Gesù ai suoi discepoli dopo la sua '
          'risurrezione?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’incarico missionario conclude il vangelo (Matteo 28:19).',
    ),
  ],
  'Mark#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Simone, Andrea e altri lo seguono (Marco 1).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['pescatori'],
    ),
    QuizQuestion(
      text:
          'Che cosa fece Gesù per l’uomo indemoniato della regione di '
          'Gerasa?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'L’uomo viene liberato e ritrova il senno (Marco 5).',
    ),
  ],
  'Mark#1': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un secondo miracolo di moltiplicazione (Marco 8).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['7'],
    ),
    QuizQuestion(
      text:
          'Che cosa bisogna diventare, secondo Gesù, per entrare nel '
          'Regno di Dio?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Gesù prende i bambini a esempio (Marco 10).',
    ),
  ],
  'Mark#2': <QuizQuestion>[
    QuizQuestion(
  ...
  'Luke#0': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'La nascita avviene a Betlemme (Luca 2).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Alcuni pastori ricevono la buona notizia (Luca 2).',
    ),
  ],
  'Luke#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quanti discepoli mandò Gesù a predicare a due a due in '
          'Luca 10?',
      options: <String>['Settanta', 'Dodici', 'Cento', 'Tre'],
      correctIndex: 0,
      explanation: 'Gesù allarga la predicazione (Luca 10).',
      type: QuizAnswerType.freeText,
      acceptedAnswers: <String>['70'],
    ),
    QuizQuestion(
      text:
          'Che cosa consiglia Gesù riguardo alla preoccupazione per il '
          'cibo e il vestito?',
      options: <String>[
      ...
      correctIndex: 0,
      explanation: 'Gesù insegna la fiducia in Dio (Luca 12).',
    ),
  ],
  'Luke#2': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quanti lebbrosi guarì Gesù, di cui uno solo tornò a '
          'ringraziare?',
      options: <String>['Dieci', 'Sette', 'Tre', 'Dodici'],
      correctIndex: 0,
      explanation: 'Solo un Samaritano torna a rendere grazie (Luca 17).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Giuda consegna Gesù (Luca 22).',
    ),
  ],
  'Acts#0': <QuizQuestion>[
    QuizQuestion(
      text:
          'Quante persone circa furono battezzate il giorno della '
          'Pentecoste?',
      options: <String>['Circa 3.000', 'Circa 500', 'Circa 12', 'Circa 100'],
      correctIndex: 0,
      explanation: 'Un gran numero risponde al messaggio (Atti 2).',
      type: QuizAnswerType.freeText,
    ...
    QuizQuestion(
      ...
      options: <String>[
        'Saulo (in seguito Paolo)',
        'Pietro',
        'Barnaba',
        'Filippo',
      ],
      correctIndex: 0,
      explanation: 'Saulo approvava questo omicidio (Atti 7-8).',
    ),
  ],
  'Acts#1': <QuizQuestion>[
    QuizQuestion(
      text:
          'Chi mandò lo spirito ad annunciare la buona notizia all’eunuco '
          'etiope?',
      options: <String>['Filippo', 'Pietro', 'Paolo', 'Giovanni'],
      correctIndex: 0,
      explanation: 'Filippo gli spiega le Scritture (Atti 8).',
      type: QuizAnswerType.freeText,
    ),
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Un angelo lo fa uscire miracolosamente (Atti 12).',
    ),
  ],
  'Acts#2': <QuizQuestion>[
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Paolo lavorava con le proprie mani (Atti 18).',
    ),
    QuizQuestion(
      text:
          'In quale città la predicazione di Paolo provocò una sommossa '
          'degli argentieri di Diana/Artemide?',
      options: <String>['Efeso', 'Atene', 'Corinto', 'Roma'],
      correctIndex: 0,
      explanation: 'Gli artigiani temevano per il loro commercio (Atti 19).',
      type: QuizAnswerType.freeText,
    ),
  ],
  'Acts#3': <QuizQuestion>[
    ...
    QuizQuestion(
      text:
          'Dove giunse infine Paolo per attendere il suo processo '
          'davanti a Cesare?',
      options: <String>['A Roma', 'A Gerusalemme', 'Ad Antiochia', 'A Efeso'],
      correctIndex: 0,
      explanation: 'Paolo predica anche agli arresti domiciliari (Atti 28).',
      type: QuizAnswerType.freeText,
